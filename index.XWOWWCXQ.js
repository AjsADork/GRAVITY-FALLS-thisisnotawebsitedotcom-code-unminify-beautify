(() => {
	...
	var mn = (a, t) => () => (t || a((t = {
		...
		fn = (a, t, e, i) => {
			if (t && typeof t == "object" || typeof t == "function")
				for (let n of cn(t)) !un.call(a, n) && n !== e && wt(a, n, {
					get: () => t[n],
					enumerable: !(i = ln(t, n)) || i.enumerable
				});
			return a
		};
	var pn = (a, t, e) => (e = a != null ? rn(dn(a)) : {}, fn(t || !a || !a.__esModule ? wt(e, "default", {
		value: a,
		enumerable: !0
	}) : e, a));
	...
	var tn = mn(ie => {
		(function() {
				...
				_unlockAudio: function() {
					...
					if (!(s._audioUnlocked || !s.ctx)) {
						...
						var r = function(d) {
							...
							Q.buffer = s._scratchBuffer, Q.connect(s.ctx.destination), typeof Q.start > "u" ? Q.noteOn(0) : Q.start(0), typeof s.ctx.resume == "function" && s.ctx.resume(), Q.onended = function() {
								Q.disconnect(0), s._audioUnlocked = !0, document.removeEventListener("touchstart", r, !0), document.removeEventListener("touchend", r, !0), document.removeEventListener("click", r, !0), document.removeEventListener("keydown", r, !0);
								for (var y = 0; y < s._howls.length; y++) s._howls[y]._emit("unlock")
							}
						};
			...
			e.prototype = {
				...
				load: function() {
					...
					for (var d = 0; d < s._src.length; d++) {
						...
						if (s._format && s._format[d]) h = s._format[d];
							...
							h = /^data:audio\/([^;,]+);/i.exec(f), h || (h = /\.([^.]+)$/.exec(f.split("?", 1)[0])), h && (h = h[1].toLowerCase())
						}
					...
					return s._src = r, s._state = "loading", window.location.protocol === "https:" && r.slice(0, 5) === "http:" && (s._html5 = !0, s._webAudio = !1), new i(s), s._webAudio && o(s), s
				},
				play: function(s, r) {
					var d = this,
						h = null;
					if (typeof s == "number") h = s, s = null;
						...
						if (typeof s > "u" && (s = "__default", !d._playLock)) {
							for (var f = 0, b = 0; b < d._sounds.length; b++) d._sounds[b]._paused && !d._sounds[b]._ended && (f++, h = d._sounds[b]._id);
							f === 1 ? s = null : h = null
						}
					}
					...
					p._sprite = s, p._ended = !1;
					var W = function() {
						p._paused = !1, p._seek = Q, p._start = k, p._stop = M, p._loop = !!(p._loop || d._sprite[s][2])
					};
					if (Q >= M) {
						d._ended(p);
						return
					...
					if (d._webAudio) {
						var Bt = function() {
							...
							x.gain.setValueAtTime(C, t.ctx.currentTime), p._playStart = t.ctx.currentTime, typeof x.bufferSource.start > "u" ? p._loop ? x.bufferSource.noteGrainOn(0, Q, 86400) : x.bufferSource.noteGrainOn(0, Q, y) : p._loop ? x.bufferSource.start(0, Q, 86400) : x.bufferSource.start(0, Q, y), B !== 1 / 0 && (d._endTimers[p._id] = setTimeout(d._ended.bind(d, p), B)), r || setTimeout(function() {
								d._emit("play", p._id), d._loadQueue()
							}, 0)
						};
						t.state === "running" && t.ctx.state !== "interrupted" ? Bt() : (d._playLock = !0, d.once("resume", Bt), d._clearTimer(p._id))
					} else {
						var xt = function() {
							x.currentTime = Q, x.muted = p._muted || d._muted || t._muted || x.muted, x.volume = p._volume * t.volume(), x.playbackRate = p._rate;
							try {
								var C = x.play();
								if (C && typeof Promise < "u" && (C instanceof Promise || typeof C.then == "function") ? (d._playLock = !0, W(), C.then(function() {
										d._playLock = !1, x._unlocked = !0, r ? d._loadQueue() : d._emit("play", p._id)
									}).catch(function() {
										d._playLock = !1, d._emit("playerror", p._id, "Playback was unable to start. This is most commonly an issue on mobile devices and Chrome where playback was not within a user interaction."), p._ended = !0, p._paused = !0
									})) : r || (d._playLock = !1, W(), d._emit("play", p._id)), x.playbackRate = p._rate, x.paused) {
								...
								s !== "__default" || p._loop ? d._endTimers[p._id] = setTimeout(d._ended.bind(d, p), B) : (d._endTimers[p._id] = function() {
									d._ended(p), x.removeEventListener("ended", d._endTimers[p._id], !1)
								}, x.addEventListener("ended", d._endTimers[p._id], !1))
							} catch (T) {
								d._emit("playerror", p._id, T)
							}
						};
						x.src === "data:audio/wav;base64,UklGRigAAABXQVZFZm10IBIAAAABAAEARKwAAIhYAQACABAAAABkYXRhAgAAAAEA" && (x.src = d._src, x.load());
						var Ut = window && window.ejecta || !x.readyState && t._navigator.isCocoonJS;
						if (x.readyState >= 3 || Ut) xt();
						else {
							d._playLock = !0, d._state = "loading";
							var ht = function() {
								d._state = "loaded", xt(), x.removeEventListener(t._canPlayEvent, ht, !1)
							};
				...
				pause: function(s) {
					...
					for (var d = r._getSoundIds(s), h = 0; h < d.length; h++) {
						...
						if (f && !f._paused && (f._seek = r.seek(d[h]), f._rateSeek = 0, f._paused = !0, r._stopFade(d[h]), f._node))
							if (r._webAudio) {
								if (!f._node.bufferSource) continue;
								typeof f._node.bufferSource.stop > "u" ? f._node.bufferSource.noteOff(0) : f._node.bufferSource.stop(0), r._cleanBuffer(f._node)
				...
				stop: function(s, r) {
					...
					for (var h = d._getSoundIds(s), f = 0; f < h.length; f++) {
						...
						b && (b._seek = b._start || 0, b._rateSeek = 0, b._paused = !0, b._ended = !0, d._stopFade(h[f]), b._node && (d._webAudio ? b._node.bufferSource && (typeof b._node.bufferSource.stop > "u" ? b._node.bufferSource.noteOff(0) : b._node.bufferSource.stop(0), d._cleanBuffer(b._node)) : (!isNaN(b._node.duration) || b._node.duration === 1 / 0) && (b._node.currentTime = b._start || 0, b._node.pause(), b._node.duration === 1 / 0 && d._clearSound(b._node))), r || d._emit("stop", b._id))
					}
					return d
				},
				mute: function(s, r) {
					...
					for (var h = d._getSoundIds(r), f = 0; f < h.length; f++) {
						var b = d._soundById(h[f]);
						b && (b._muted = s, b._interval && d._stopFade(b._id), d._webAudio && b._node ? b._node.gain.setValueAtTime(s ? 0 : b._volume, t.ctx.currentTime) : b._node && (b._node.muted = t._muted ? !0 : s), d._emit("mute", b._id))
					}
					return d
				},
				volume: function() {
					...
					if (typeof d < "u" && d >= 0 && d <= 1) {
						...
						for (var g = 0; g < h.length; g++) p = s._soundById(h[g]), p && (p._volume = d, r[2] || s._stopFade(h[g]), s._webAudio && p._node && !p._muted ? p._node.gain.setValueAtTime(d, t.ctx.currentTime) : p._node && !p._muted && (p._node.volume = d * t.volume()), s._emit("volume", p._id))
					} else return p = h ? s._soundById(h) : s._sounds[0], p ? p._volume : 0;
					return s
				},
				fade: function(s, r, d, h) {
					...
					s = Math.min(Math.max(0, parseFloat(s)), 1), r = Math.min(Math.max(0, parseFloat(r)), 1), d = parseFloat(d), f.volume(s, h);
						...
						if (g) {
							if (h || f._stopFade(b[p]), f._webAudio && !g._muted) {
								var Q = t.ctx.currentTime,
									y = Q + d / 1e3;
								g._volume = s, g._node.gain.setValueAtTime(s, Q), g._node.gain.linearRampToValueAtTime(r, y)
							}
				...
				_startFadeInterval: function(s, r, d, h, f, b) {
					...
					s._fadeTo = d, s._interval = setInterval(function() {
						var M = (Date.now() - k) / h;
						k = Date.now(), g += Q * M, g = Math.round(g * 100) / 100, Q < 0 ? g = Math.max(d, g) : g = Math.min(d, g), p._webAudio ? s._volume = g : p.volume(g, s._id, !0), b && (p._volume = g), (d < r && g <= d || d > r && g >= d) && (clearInterval(s._interval), s._interval = null, s._fadeTo = null, p.volume(d, s._id), p._emit("fade", s._id))
					}, B)
				},
				...
				loop: function() {
					...
					if (r.length === 1)
						...
						else return f = s._soundById(parseInt(r[0], 10)), f ? f._loop : !1;
					else r.length === 2 && (d = r[0], h = parseInt(r[1], 10));
					for (var b = s._getSoundIds(h), p = 0; p < b.length; p++) f = s._soundById(b[p]), f && (f._loop = d, s._webAudio && f._node && f._node.bufferSource && (f._node.bufferSource.loop = d, d && (f._node.bufferSource.loopStart = f._start || 0, f._node.bufferSource.loopEnd = f._stop, s.playing(b[p]) && (s.pause(b[p], !0), s.play(b[p], !0)))));
					return s
				},
				rate: function() {
					var s = this,
					...
					if (typeof d == "number") {
						...
						for (var g = 0; g < h.length; g++)
							if (p = s._soundById(h[g]), p) {
								s.playing(h[g]) && (p._rateSeek = s.seek(h[g]), p._playStart = s._webAudio ? t.ctx.currentTime : p._playStart), p._rate = d, s._webAudio && p._node && p._node.bufferSource ? p._node.bufferSource.playbackRate.setValueAtTime(d, t.ctx.currentTime) : p._node && (p._node.playbackRate = d);
								var Q = s.seek(h[g]),
									y = (s._sprite[p._sprite][0] + s._sprite[p._sprite][1]) / 1e3 - Q,
									B = y * 1e3 / Math.abs(p._rate);
								(s._endTimers[h[g]] || !p._paused) && (s._clearTimer(h[g]), s._endTimers[h[g]] = setTimeout(s._ended.bind(s, p), B)), s._emit("rate", p._id)
							}
				...
				seek: function() {
					...
					if (r.length === 0) s._sounds.length && (h = s._sounds[0]._id);
						...
						var f = s._getSoundIds(),
							b = f.indexOf(r[0]);
						b >= 0 ? h = parseInt(r[0], 10) : s._sounds.length && (h = s._sounds[0]._id, d = parseFloat(r[0]))
					} else r.length === 2 && (d = parseFloat(r[0]), h = parseInt(r[1], 10));
					...
					if (p)
						if (typeof d == "number" && d >= 0) {
							var g = s.playing(h);
							g && s.pause(h, !0), p._seek = d, p._ended = !1, s._clearTimer(h), !s._webAudio && p._node && !isNaN(p._node.duration) && (p._node.currentTime = d);
							var Q = function() {
				...
				unload: function() {
					...
					return n && f && delete n[s._src], t.noAudio = !1, s._state = "unloaded", s._sounds = [], s = null, null
				},
				on: function(s, r, d, h) {
					var f = this,
						b = f["_on" + s];
				...
				off: function(s, r, d) {
					...
					if (typeof r == "number" && (d = r, r = null), r || d)
						for (b = 0; b < f.length; b++) {
							...
							var g = Object.keys(h);
							for (b = 0; b < g.length; b++) g[b].indexOf("_on") === 0 && Array.isArray(h[g[b]]) && (h[g[b]] = [])
						}
					return h
				},
				once: function(s, r, d) {
				...
				_emit: function(s, r, d) {
					for (var h = this, f = h["_on" + s], b = f.length - 1; b >= 0; b--)(!f[b].id || f[b].id === r || s === "load") && (setTimeout(function(p) {
						p.call(this, r, d)
					}.bind(h, f[b].fn), 0), f[b].once && h.off(s, f[b].fn, f[b].id));
				...
				_ended: function(s) {
					...
					if (r._emit("end", s._id), !r._webAudio && h && r.stop(s._id, !0).play(s._id), r._webAudio && h) {
					...
					return r._webAudio && !h && (s._paused = !0, s._ended = !0, s._seek = s._start || 0, s._rateSeek = 0, r._clearTimer(s._id), r._cleanBuffer(s._node), t._autoSuspend()), !r._webAudio && !h && r.stop(s._id, !0), r
				},
				...
				_refreshBuffer: function(s) {
					var r = this;
					return s._node.bufferSource = t.ctx.createBufferSource(), s._node.bufferSource.buffer = n[r._src], s._panner ? s._node.bufferSource.connect(s._panner) : s._node.bufferSource.connect(s._node), s._node.bufferSource.loop = s._loop, s._loop && (s._node.bufferSource.loopStart = s._start || 0, s._node.bufferSource.loopEnd = s._stop || 0), s._node.bufferSource.playbackRate.setValueAtTime(s._rate, t.ctx.currentTime), r
				},
			...
			var n = {},
				o = function(s) {
					...
					if (/^data:[^;]+;base64,/.test(r)) {
						for (var d = atob(r.split(",")[1]), h = new Uint8Array(d.length), f = 0; f < d.length; ++f) h[f] = d.charCodeAt(f);
						c(h.buffer, s)
					} else {
						var b = new XMLHttpRequest;
						b.open(s._xhr.method, r, !0), b.withCredentials = s._xhr.withCredentials, b.responseType = "arraybuffer", s._xhr.headers && Object.keys(s._xhr.headers).forEach(function(p) {
							...
							s._webAudio && (s._html5 = !0, s._webAudio = !1, s._sounds = [], delete n[r], s.load())
						}, l(b)
					}
				},
				l = function(s) {
			...
			}), typeof ie < "u" && (ie.Howler = t, ie.Howl = e), typeof global < "u" ? (global.HowlerGlobal = a, global.Howler = t, global.Howl = e, global.Sound = i) : typeof window < "u" && (window.HowlerGlobal = a, window.Howler = t, window.Howl = e, window.Sound = i)
		})();
		(function() {
			"use strict";
			HowlerGlobal.prototype._pos = [0, 0, 0], HowlerGlobal.prototype._orientation = [0, 0, -1, 0, 1, 0], HowlerGlobal.prototype.stereo = function(t) {
				...
				if (e = typeof e != "number" ? n._pos[1] : e, i = typeof i != "number" ? n._pos[2] : i, typeof t == "number") n._pos = [t, e, i], typeof n.ctx.listener.positionX < "u" ? (n.ctx.listener.positionX.setTargetAtTime(n._pos[0], Howler.ctx.currentTime, .1), n.ctx.listener.positionY.setTargetAtTime(n._pos[1], Howler.ctx.currentTime, .1), n.ctx.listener.positionZ.setTargetAtTime(n._pos[2], Howler.ctx.currentTime, .1)) : n.ctx.listener.setPosition(n._pos[0], n._pos[1], n._pos[2]);
				else return n._pos;
				return n
				...
				if (e = typeof e != "number" ? u[1] : e, i = typeof i != "number" ? u[2] : i, n = typeof n != "number" ? u[3] : n, o = typeof o != "number" ? u[4] : o, l = typeof l != "number" ? u[5] : l, typeof t == "number") c._orientation = [t, e, i, n, o, l], typeof c.ctx.listener.forwardX < "u" ? (c.ctx.listener.forwardX.setTargetAtTime(t, Howler.ctx.currentTime, .1), c.ctx.listener.forwardY.setTargetAtTime(e, Howler.ctx.currentTime, .1), c.ctx.listener.forwardZ.setTargetAtTime(i, Howler.ctx.currentTime, .1), c.ctx.listener.upX.setTargetAtTime(n, Howler.ctx.currentTime, .1), c.ctx.listener.upY.setTargetAtTime(o, Howler.ctx.currentTime, .1), c.ctx.listener.upZ.setTargetAtTime(l, Howler.ctx.currentTime, .1)) : c.ctx.listener.setOrientation(t, e, i, n, o, l);
				else return u;
				return c
				...
				for (var o = i._getSoundIds(e), l = 0; l < o.length; l++) {
					...
					if (c)
						if (typeof t == "number") c._stereo = t, c._pos = [t, 0, 0], c._node && (c._pannerAttr.panningModel = "equalpower", (!c._panner || !c._panner.pan) && a(c, n), n === "spatial" ? typeof c._panner.positionX < "u" ? (c._panner.positionX.setValueAtTime(t, Howler.ctx.currentTime), c._panner.positionY.setValueAtTime(0, Howler.ctx.currentTime), c._panner.positionZ.setValueAtTime(0, Howler.ctx.currentTime)) : c._panner.setPosition(t, 0, 0) : c._panner.pan.setValueAtTime(t, Howler.ctx.currentTime)), i._emit("stereo", c._id);
				...
				if (e = typeof e != "number" ? o._orientation[1] : e, i = typeof i != "number" ? o._orientation[2] : i, typeof n > "u")
					if (typeof t == "number") o._orientation = [t, e, i];
					else return o._orientation;
				for (var l = o._getSoundIds(n), c = 0; c < l.length; c++) {
					var u = o._soundById(l[c]);
					if (u)
						if (typeof t == "number") u._orientation = [t, e, i], u._node && (u._panner || (u._pos || (u._pos = o._pos || [0, 0, -.5]), a(u, "spatial")), typeof u._panner.orientationX < "u" ? (u._panner.orientationX.setValueAtTime(t, Howler.ctx.currentTime), u._panner.orientationY.setValueAtTime(e, Howler.ctx.currentTime), u._panner.orientationZ.setValueAtTime(i, Howler.ctx.currentTime)) : u._panner.setOrientation(t, e, i)), o._emit("orientation", u._id);
				...
				if (e.length === 1)
					if (typeof e[0] == "object") i = e[0], typeof n > "u" && (i.pannerAttr || (i.pannerAttr = {
					...
					else return o = t._soundById(parseInt(e[0], 10)), o ? o._pannerAttr : t._pannerAttr;
	...
	var ae = class {
			...
			removeMappedEventListenerFor(t) {
				let {
					...
					eventName: i,
					eventOptions: n
				} = t, o = this.fetchEventListenerMapForEventTarget(e), l = this.cacheKey(i, n);
	...
	var si = ["meta", "ctrl", "alt", "shift"],
		ce = class {
			constructor(t, e, i, n) {
				this.element = t, this.index = e, this.eventTarget = i.eventTarget || t, this.eventName = i.eventName || Un(t) || Lt("missing event name"), this.eventOptions = i.eventOptions || {}, this.identifier = i.identifier || Lt("missing identifier"), this.methodName = i.methodName || Lt("missing method name"), this.keyFilter = i.keyFilter || "", this.schema = n
			}
			static forToken(t, e) {
			...
			shouldIgnoreKeyboardEvent(t) {
				...
				return i ? (le(this.keyMappings, i) || Lt(`contains unknown key filter: ${this.keyFilter}`), this.keyMappings[i].toLowerCase() !== t.key.toLowerCase()) : !1
			}
	...
	var de = class {
		...
		Wt = class {
			constructor(t, e) {
				this.mutationObserverInit = {
					...
					childList: !0,
					subtree: !0
				}, this.element = t, this.started = !1, this.delegate = e, this.elements = new Set, this.mutationObserver = new MutationObserver(i => this.processMutations(i))
			}
			start() {
		...
		Ct = class {
			constructor(t, e, i) {
				this.attributeName = e, this.delegate = i, this.elementObserver = new Wt(t, this)
			}
			get element() {
	...
	var ue = class {
			constructor(t, e, i, n) {
				this._selector = e, this.details = n, this.elementObserver = new Wt(t, this), this.delegate = i, this.matchesByElement = new j
			}
			get started() {
				return this.elementObserver.started
			}
		...
		he = class {
			constructor(t, e) {
				this.element = t, this.delegate = e, this.started = !1, this.stringMap = new Map, this.mutationObserver = new MutationObserver(i => this.processMutations(i))
			}
			start() {
		...
		Et = class {
			constructor(t, e, i) {
				this.attributeObserver = new Ct(t, e, this), this.delegate = i, this.tokensByElement = new j
			}
			get started() {
	...
	var Zt = class {
			constructor(t, e, i) {
				this.tokenListObserver = new Et(t, e, this), this.delegate = i, this.parseResultsByToken = new WeakMap, this.valuesByTokenByElement = new WeakMap
			}
			get started() {
		...
		me = class {
			...
			start() {
				this.valueListObserver || (this.valueListObserver = new Zt(this.element, this.actionAttribute, this), this.valueListObserver.start())
			}
			stop() {
		...
		fe = class {
			constructor(t, e) {
				this.context = t, this.receiver = e, this.stringMapObserver = new he(this.element, this), this.valueDescriptorMap = this.controller.valueDescriptorMap
			}
			start() {
			...
			invokeChangedCallbacksForDefaultValues() {
				for (let {
					...
					of this.valueDescriptors) i != null && !this.controller.data.has(t) && this.invokeChangedCallback(e, n(i), void 0)
			}
		...
		pe = class {
			...
			start() {
				this.tokenListObserver || (this.tokenListObserver = new Et(this.element, this.attributeName, this), this.tokenListObserver.start())
			}
			stop() {
	...
	function pt(a, t) {
		let e = fi(a);
		return Array.from(e.reduce((i, n) => (Mn(n, t).forEach(o => i.add(o)), i), new Set))
	}
	...
	var be = class {
			constructor(t, e) {
				this.started = !1, this.context = t, this.delegate = e, this.outletsByName = new j, this.outletElementsByName = new j, this.selectorObserverMap = new Map, this.attributeObserverMap = new Map
			}
			start() {
			...
			disconnectAllOutlets() {
				for (let t of this.outletElementsByName.keys)
					for (let e of this.outletElementsByName.getValuesForKey(t))
						for (let i of this.outletsByName.getValuesForKey(t)) this.disconnectOutlet(i, e, t)
			}
		...
		ge = class {
			constructor(t, e) {
				this.logDebugActivity = (i, n = {}) => {
					...
					n = Object.assign({
						...
						controller: l,
						element: c
					}, n), this.application.logDebugActivity(this.identifier, i, n)
				}, this.module = t, this.scope = e, this.controller = new t.controllerConstructor(this), this.bindingObserver = new me(this, this.dispatcher), this.valueObserver = new fe(this, this.controller), this.targetObserver = new pe(this, this), this.outletObserver = new be(this, this);
				try {
			...
			handleError(t, e, i = {}) {
				...
				i = Object.assign({
					...
					controller: o,
					element: l
				}, i), this.application.handleError(t, `Error ${e}`, i)
			}
			targetConnected(t, e) {
	...
	var Qe = class {
			constructor(t, e) {
				this.application = t, this.definition = Nn(e), this.contextsByScope = new WeakMap, this.connectedContexts = new Set
			}
			get identifier() {
		...
		ve = class {
			...
			warn(t, e, i) {
				...
				n || (n = new Set, this.warnedKeysByObject.set(t, n)), n.has(e) || (n.add(e), this.logger.warn(i, t))
			}
		};
	...
	var xe = class {
			...
			deprecate(t, e) {
				if (t) {
					let {
						identifier: i
					} = this, n = this.schema.targetAttribute, o = this.schema.targetAttributeForScope(i);
		...
		we = class a {
			constructor(t, e, i, n) {
				this.targets = new xe(this), this.classes = new Fe(this), this.data = new ye(this), this.containsElement = o => o.closest(this.controllerSelector) === this.element, this.schema = t, this.element = e, this.identifier = i, this.guide = new ve(n), this.outlets = new Ue(this.documentScope, e)
			}
			findElement(t) {
		...
		Le = class {
			constructor(t, e, i) {
				this.element = t, this.schema = e, this.delegate = i, this.valueListObserver = new Zt(this.element, this.controllerAttribute, this), this.scopesByIdentifierByElement = new WeakMap, this.scopeReferenceCounts = new WeakMap
			}
			start() {
		...
		We = class {
			constructor(t) {
				this.application = t, this.scopeObserver = new Le(this.element, this.schema, this), this.scopesByIdentifier = new j, this.modulesByIdentifier = new Map
			}
			get element() {
	...
	var kt = class {
		constructor(t = document.documentElement, e = Tn) {
			this.logger = console, this.debug = !1, this.logDebugActivity = (i, n, o = {}) => {
				this.debug && this.logFormattedMessage(i, n, o)
			}, this.element = t, this.schema = e, this.dispatcher = new ae(this), this.router = new We(this), this.actionDescriptorFilters = Object.assign({}, gn)
		}
		static start(t, e) {
			let i = new this(t, e);
			return i.start(), i
		...
		async start() {
			await An(), this.logDebugActivity("application", "starting"), this.dispatcher.start(), this.router.start(), this.logDebugActivity("application", "start")
		}
		stop() {
...
%o`, e, t, i), (n = window.onerror) === null || n === void 0 || n.call(window, e, "", 0, 0, t)
		...
		logFormattedMessage(t, e, i = {}) {
			i = Object.assign({
				application: this
			}, i), this.logger.groupCollapsed(`${t} #${e}`), this.logger.log("details:", Object.assign({}, i)), this.logger.groupEnd()
		}
	};
	...
	function li(a, t, e) {
		let i = ri(a, t, e);
		if (i || (a.application.router.proposeToConnectScopeForElementAndIdentifier(t, e), i = ri(a, t, e), i)) return i
	}
	...
	function mt(a) {
		...
		if (Object.prototype.toString.call(a) === "[object Object]") return "object"
	}
	...
	function qn(a) {
		let {
			...
			token: e,
			typeObject: i
		} = a, n = ni(i.type), o = ni(i.default), l = n && o, c = n && !o, u = !n && o, m = Ot(i.type), s = mt(a.typeObject.default);
		if (c) return m;
		if (u) return s;
		if (m !== s) {
			let r = t ? `${t}.${e}` : e;
	...
	var ci = {get array() {
		...
		ns = {
			array(a) {
				let t = JSON.parse(a);
				if (!Array.isArray(t)) throw new TypeError(`expected value of type "array" but instead got value "${a}" of type "${mt(t)}"`);
				return t
			}, boolean(a) {
				...
				let t = JSON.parse(a);
				if (t === null || typeof t != "object" || Array.isArray(t)) throw new TypeError(`expected value of type "object" but instead got value "${a}" of type "${mt(t)}"`);
				return t
			}, string(a) {
				return a
			}
	...
	var F = (a, t = 1e4) => (a = parseFloat(a + "") || 0, Math.round((a + Number.EPSILON) * t) / t),
		Se = function(a) {
		...
		ze = class {
			constructor(t, {
				...
				for (let o of["onPointerStart", "onTouchStart", "onMove", "onTouchEnd", "onPointerEnd", "onWindowBlur"]) this[o] = this[o].bind(this);
				this.element.addEventListener("mousedown", this.onPointerStart, ot), this.element.addEventListener("touchstart", this.onTouchStart, ot), this.element.addEventListener("touchmove", this.onMove, ot), this.element.addEventListener("touchend", this.onTouchEnd), this.element.addEventListener("touchcancel", this.onTouchEnd)
			}
			onPointerStart(t) {
			...
			onTouchStart(t) {
				for (let e of Array.from(t.changedTouches || [])) this.triggerPointerStart(new $(e), t);
			...
			onPointerEnd(t) {
				t.buttons > 0 && t.button !== 0 || (this.triggerPointerEnd(t, new $(t)), window.removeEventListener("mousemove", this.onMove), window.removeEventListener("mouseup", this.onPointerEnd), window.removeEventListener("blur", this.onWindowBlur))
			}
			onTouchEnd(t) {
				for (let e of Array.from(t.changedTouches || [])) this.triggerPointerEnd(t, new $(e))
			}
	...
	var je = a => typeof a == "object" && a !== null && a.constructor === Object && Object.prototype.toString.call(a) === "[object Object]",
		...
		ut = class {
			...
			setOptions(t) {
				...
				for (let [e, i] of Object.entries(this.option("on") || {})) this.on(e, i)
			}
			option(t, ...e) {
			...
			optionFor(t, e, i, ...n) {
				let o = Ee(e, t);
				var l;
				typeof(l = o) != "string" || isNaN(l) || isNaN(parseFloat(l)) || (o = parseFloat(o)), o === "true" && (o = !0), o === "false" && (o = !1), o && typeof o == "function" && (o = o.call(this, this, t, ...n));
				let c = Ee(e, this.options);
				return c && typeof c == "function" ? o = c.call(this, this, t, ...n, o) : o === void 0 && (o = c), o === void 0 ? i : o
			}
			cn(t) {
			...
			localize(t, e = []) {
				t = String(t).replace(/\{\{(\w+).?(\w+)?\}\}/g, (i, n, o) => {
					let l = "";
					return o ? l = this.option(`${n[0]+n.toLowerCase().substring(1)}.l10n.${o}`) : n && (l = this.option(`l10n.${n}`)), l || (l = i), l
				});
			...
			on(t, e) {
				let i = [];
				typeof t == "string" ? i = t.split(" ") : Array.isArray(t) && (i = t), this.events || (this.events = new Map), i.forEach(n => {
					let o = this.events.get(n);
					o || (this.events.set(n, []), o = []), o.includes(e) || o.push(e), this.events.set(n, o)
				})
			}
			off(t, e) {
				let i = [];
				typeof t == "string" ? i = t.split(" ") : Array.isArray(t) && (i = t), i.forEach(n => {
					let o = this.events.get(n);
					if (Array.isArray(o)) {
						let l = o.indexOf(e);
						l > -1 && o.splice(l, 1)
			...
			emit(t, ...e) {
				[...this.events.get(t) || []].forEach(i => i(this, ...e)), t !== "*" && this.emit("*", t, ...e)
			}
		};
	...
	var yt = class extends ut {
			...
			attachPlugins(t = {}) {
				...
				for (let [i, n] of Object.entries(t)) {
					let o = this.option(i),
						l = this.plugins[i];
					l || o === !1 ? l && o === !1 && (l.detach(), delete this.plugins[i]) : e.set(i, new n(this, o || {}))
				}
		...
		w;
	(function(a) {
		a[a.Init = 0] = "Init", a[a.Error = 1] = "Error", a[a.Ready = 2] = "Ready", a[a.Panning = 3] = "Panning", a[a.Mousemove = 4] = "Mousemove", a[a.Destroy = 5] = "Destroy"
	})(w || (w = {}));
	var J = ["a", "b", "c", "d", "e", "f"],
		Si = {
			PANUP: "Move up",
		...
		Ze = null,
		ke = null,
		st = class a extends yt {get fits() {
				return this.contentRect.width - this.contentRect.fitWidth < 1 && this.contentRect.height - this.contentRect.fitHeight < 1
			}
			get isTouchDevice() {
				return ke === null && (ke = window.matchMedia("(hover: none)").matches), ke
			}get isMobile() {
				return Ze === null && (Ze = /iPhone|iPad|iPod|Android/i.test(navigator.userAgent)), Ze
			}
			get panMode() {
			...
			constructor(t, e = {}, i = {}) {
				...
				this.container = t, this.initContent(), this.attachPlugins(Object.assign(Object.assign({}, a.Plugins), i)), this.emit("attachPlugins"), this.emit("init");
				let o = this.content;
			...
			initContent() {
				let {
					container: t
				} = this, e = this.cn(yi), i = this.option(yi) || t.querySelector(`.${e}`);
				if (i || (i = t.querySelector("img,picture") || t.firstElementChild, i && v(i, e)), i instanceof HTMLPictureElement && (i = i.querySelector("img")), !i) throw new Error("No content found");
				this.content = i
			}
			onLoad() {
				let {
				...
				t && (t.remove(), this.spinner = null), this.option("spinner") && e.classList.remove(this.cn("isLoading")), this.emit("afterLoad"), i === w.Init ? this.enable() : this.updateMetrics()
			}
			onError() {
				this.state !== w.Destroy && (this.spinner && (this.spinner.remove(), this.spinner = null), this.stop(), this.detachEvents(), this.state = w.Error, this.emit("error"))
			}
			getNextScale(t) {
				let {
					fullScale: e,
			...
			detachEvents() {
				...
				e.removeEventListener("click", this.onClick, {
					...
					passive: !1
				}), (t = this.pointerTracker) === null || t === void 0 || t.stop(), this.pointerTracker = null, document.removeEventListener(D, this.onMouseMove), document.removeEventListener("keydown", this.onKeydown, !0), this.clickTimer && (clearTimeout(this.clickTimer), this.clickTimer = null), this.updateTimer && (clearTimeout(this.updateTimer), this.updateTimer = null)
			}
			animate() {
				this.setTargetForce();
				let t = this.friction,
					e = this.option("maxVelocity");
				for (let i of J) t ? (this.velocity[i] *= 1 - t, e && !this.isScaling && (this.velocity[i] = Math.max(Math.min(this.velocity[i], e), -1 * e)), this.current[i] += this.velocity[i]) : this.current[i] = this.target[i];
				this.setTransform(), this.setEdgeForce(), !this.isResting || this.isDragging ? this.rAF = requestAnimationFrame(() => this.animate()) : this.stop("current")
			}
			setTargetForce() {
				for (let t of J) t === "e" && this.isBouncingX || t === "f" && this.isBouncingY || (this.velocity[t] = (1 / (1 - this.friction) - 1) * (this.target[t] - this.current[t]))
			}
			checkBounds(t = 0, e = 0) {
				let {
					current: i
				} = this, n = i.e + t, o = i.f + e, l = this.getBounds(), {
					x: c,
					y: u
				} = l, m = c.min, s = c.max, r = u.min, d = u.max, h = 0, f = 0;
				return m !== 1 / 0 && n < m ? h = m - n : s !== 1 / 0 && n > s && (h = s - n), r !== 1 / 0 && o < r ? f = r - o : d !== 1 / 0 && o > d && (f = d - o), Math.abs(h) < 1e-4 && (h = 0), Math.abs(f) < 1e-4 && (f = 0), Object.assign(Object.assign({}, l), {
					xDiff: h,
					yDiff: f,
					inBounds: !h && !f
				})
			...
			setEdgeForce() {
				if (this.ignoreBounds || this.isDragging || this.panMode === D || this.targetScale < this.scale) return this.isBouncingX = !1, void(this.isBouncingY = !1);
				let {
					target: t
				} = this, {
					x: e,
				...
				n !== 0 ? (this.isBouncingX = !0, n * c <= 0 ? c += .14 * n : (c = .14 * n, e.min !== 1 / 0 && (this.target.e = Math.max(t.e, e.min)), e.max !== 1 / 0 && (this.target.e = Math.min(t.e, e.max))), l && (c = Math.max(Math.min(c, l), -1 * l))) : this.isBouncingX = !1, o !== 0 ? (this.isBouncingY = !0, o * u <= 0 ? u += .14 * o : (u = .14 * o, i.min !== 1 / 0 && (this.target.f = Math.max(t.f, i.min)), i.max !== 1 / 0 && (this.target.f = Math.min(t.f, i.max))), l && (u = Math.max(Math.min(u, l), -1 * l))) : this.isBouncingY = !1, this.isBouncingX && (this.velocity.e = c), this.isBouncingY && (this.velocity.f = u)
			}
			enable() {
				let {
					content: t
				...
				this.updateMetrics(), this.attachObserver(), this.attachEvents(), this.state = w.Ready, this.emit("ready")
			}
			onClick(t) {
				var e;
			...
			onPointerDown(t, e, i) {
				...
				if (this.panMode === D && this.targetScale > 1) return t.preventDefault(), t.stopPropagation(), !1;
			...
			onPointerMove(t, e, i) {
				if (this.option("touch", t) === !1 || !this.isDragging || e.length < 2 && this.panOnlyZoomed && F(this.targetScale) <= F(this.minScale) || (this.emit("touchMove", t), t.defaultPrevented)) return;
				this.addTrackingPoint(e[0]);
				let {
					content: n
				} = this, o = gi(i[0], i[1]), l = gi(e[0], e[1]), c = 0, u = 0;
				if (e.length > 1) {
					let y = n.getBoundingClientRect();
					c = o.clientX - y.left - .5 * y.width, u = o.clientY - y.top - .5 * y.height
				}
				let m = bi(i[0], i[1]),
					s = bi(e[0], e[1]),
					r = m ? s / m : 1,
				...
				if (f && !this.lockedAxis)
					if (f === "xy" || f === "y" || t.type === "touchmove") {
						...
						this.lockedAxis = y > 45 && y < 135 ? "y" : "x", this.dragOffset.x = 0, this.dragOffset.y = 0, d = 0, h = 0
					} else this.lockedAxis = f;
				if (St(t.target, this.content) && (f = "x", this.dragOffset.y = 0), f && f !== "xy" && this.lockedAxis !== f && F(this.targetScale) === F(this.minScale)) return;
				t.cancelable && t.preventDefault(), this.container.classList.add(this.cn("isDragging"));
				let b = this.checkBounds(d, h);
				this.option("rubberband") ? (this.isInfinite !== "x" && (b.xDiff > 0 && d < 0 || b.xDiff < 0 && d > 0) && (d *= Math.max(0, .5 - Math.abs(.75 / this.contentRect.fitWidth * b.xDiff))), this.isInfinite !== "y" && (b.yDiff > 0 && h < 0 || b.yDiff < 0 && h > 0) && (h *= Math.max(0, .5 - Math.abs(.75 / this.contentRect.fitHeight * b.yDiff)))) : (b.xDiff && (d = 0), b.yDiff && (h = 0));
				let p = this.targetScale,
					g = this.minScale,
					Q = this.maxScale;
				p < .5 * g && (r = Math.max(r, g)), p > 1.5 * Q && (r = Math.min(r, Q)), this.lockedAxis === "y" && F(p) === F(g) && (d = 0), this.lockedAxis === "x" && F(p) === F(g) && (h = 0), this.applyChange({
					originX: c,
					originY: u,
					panX: d,
					panY: h,
			...
			onPointerUp(t, e, i) {
				...
				this.container.classList.remove(this.cn("isDragging")), this.isDragging && (this.addTrackingPoint(e), this.panOnlyZoomed && this.contentRect.width - this.contentRect.fitWidth < 1 && this.contentRect.height - this.contentRect.fitHeight < 1 && (this.trackingPoints = []), St(t.target, this.content) && this.lockedAxis === "y" && (this.trackingPoints = []), this.emit("touchEnd", t), this.isDragging = !1, this.lockedAxis = !1, this.state !== w.Destroy && (t.defaultPrevented || this.startDecelAnim()))
			}
			startDecelAnim() {
				var t;
				...
				this.target.e = this.current.e, this.target.f = this.current.f, U(this.container, "is-scaling"), U(this.container, "is-animating"), this.isTicking = !1;
				let {
					trackingPoints: i
				} = this, n = i[0], o = i[i.length - 1], l = 0, c = 0, u = 0;
				o && n && (l = o.clientX - n.clientX, c = o.clientY - n.clientY, u = o.time - n.time);
				...
				if (u > 0) {
					...
					y && (d = Math.max(Math.min(d, y), -1 * y), h = Math.max(Math.min(h, y), -1 * y))
				}
				d && (s = d / (1 / (1 - f) - 1)), h && (r = h / (1 / (1 - f) - 1)), (this.option("lockAxis") === "y" || this.option("lockAxis") === "xy" && this.lockedAxis === "y" && F(b) === this.minScale) && (s = d = 0), (this.option("lockAxis") === "x" || this.option("lockAxis") === "xy" && this.lockedAxis === "x" && F(b) === this.minScale) && (r = h = 0);
				let p = this.dragOffset.x,
					g = this.dragOffset.y,
					Q = this.option("dragMinThreshold") || 0;
				Math.abs(p) < Q && Math.abs(g) < Q && (s = r = 0, d = h = 0), (this.option("zoom") && (b < this.minScale - 1e-5 || b > this.maxScale + 1e-5) || e && !s && !r) && (f = .35), this.applyChange({
					panX: s,
					panY: r,
					friction: f
			...
			onWheel(t) {
				...
				if (this.emit("wheel", t, i), this.panMode === D || t.defaultPrevented) return;
			...
			setTransform() {
				...
				let {
					...
					content: i,
					contentRect: n
				} = this, o = Object.assign({}, Mt);
				for (let p of J) {
					let g = p == "e" || p === "f" ? It : as;
					o[p] = F(t[p], g), Math.abs(e[p] - t[p]) < (p == "e" || p === "f" ? .51 : .001) && (t[p] = e[p])
				}
				let {
					a: l,
					b: c,
					...
					e: s,
					f: r
				} = o, d = `matrix(${l}, ${c}, ${u}, ${m}, ${s}, ${r})`, h = i.parentElement instanceof HTMLPictureElement ? i.parentElement : i;
			...
			updateMetrics(t = !1) {
				...
				let f = parseFloat(o.dataset.width || "") || (C => {
						let T = 0;
						return T = C instanceof HTMLImageElement ? C.naturalWidth : C instanceof SVGElement ? C.width.baseVal.value : Math.max(C.offsetWidth, C.scrollWidth), T || 0
					})(o),
					b = parseFloat(o.dataset.height || "") || (C => {
						let T = 0;
						return T = C instanceof HTMLImageElement ? C.naturalHeight : C instanceof SVGElement ? C.height.baseVal.value : Math.max(C.offsetHeight, C.scrollHeight), T || 0
					})(o),
					p = this.option("width", f) || X,
					g = this.option("height", b) || X,
					Q = p === X,
					y = g === X;
				typeof p != "number" && (p = f), typeof g != "number" && (g = b), Q && (p = f * (g / b)), y && (g = b / (f / p));
				...
				B.style.setProperty("transform", "none", "important"), l && (B.style.width = "", B.style.height = ""), B.offsetHeight;
				let M = o.getBoundingClientRect(),
					W = M.width * i,
					x = M.height * i,
					Bt = W,
					xt = x;
				W = Math.min(W, p), x = Math.min(x, g), l ? {
					width: W,
					height: x
				} = ((C, T, nn, sn) => {
					let on = nn / C,
				...
				})(p, g, W, x) : (W = Math.min(W, p), x = Math.min(x, g));
				let Ut = .5 * (xt - x),
					ht = .5 * (Bt - W);
				this.contentRect = Object.assign(Object.assign({}, this.contentRect), {
					...
					fullWidth: p,
					fullHeight: g
				}), B.style.cssText = k, l && (B.style.width = `${W}px`, B.style.height = `${x}px`), this.setTransform(), t !== !0 && this.emit("refresh"), this.ignoreBounds || (F(this.targetScale) < F(this.minScale) ? this.zoomTo(this.minScale, {
					friction: 0
				}) : this.targetScale > this.maxScale ? this.zoomTo(this.maxScale, {
					friction: 0
				}) : this.state === w.Init || this.checkBounds().inBounds || this.requestTick()), this.updateControls()
			}
			calculateBounds() {
				let {
					contentWidth: t,
				...
				if (r === !0 || n && r === n) c = -1 / 0, m = 1 / 0, u = -1 / 0, s = 1 / 0;
				else {
					let {
						containerRect: d,
						contentRect: h
					} = this, f = F(o * i, It), b = F(l * i, It), {
						innerWidth: p,
						innerHeight: g
					} = d;
					if (d.width === f && (p = d.width), d.width === b && (g = d.height), t > p) {
						m = .5 * (t - p), c = -1 * m;
						let Q = .5 * (h.right - h.left);
						c += Q, m += Q
					}
					if (o > p && t < p && (c -= .5 * (o - p), m -= .5 * (o - p)), e > g) {
						s = .5 * (e - g), u = -1 * s;
						let Q = .5 * (h.bottom - h.top);
						u += Q, s += Q
					}
					l > g && e < g && (c -= .5 * (l - g), m -= .5 * (l - g))
				}
				return {
					x: {
						min: c,
			...
			updateControls() {
				...
				let m = t.canZoomIn(),
					...
					d = s && r;
				if (r && (F(o) < F(l) && !this.panOnlyZoomed && (d = !0), (F(n.width, 1) > F(n.fitWidth, 1) || F(n.height, 1) > F(n.fitHeight, 1)) && (d = !0)), F(n.width * o, 1) < F(n.fitWidth, 1) && (d = !1), i === D && (d = !1), z(e, this.cn("isDraggable"), d), !this.option("zoom")) return;
				let h = m && F(c) > F(o),
					f = !h && !d && s && F(c) < F(o);
				...
				for (let b of e.querySelectorAll("[data-panzoom-action]")) {
					...
					p ? (b.removeAttribute("disabled"), b.removeAttribute("tabindex")) : g && (b.setAttribute("disabled", ""), b.setAttribute("tabindex", "-1"))
				}
			}
			panTo({
				x: t = this.target.e,
			...
			applyChange({
				...
				let {
					current: h
				} = this, f = h.e, b = h.f, p = this.getMatrix(this.target), g = new DOMMatrix().translate(f, b).translate(o, l).translate(t, e);
				if (this.option("zoom")) {
					if (!s) {
				...
				g = g.translate(-o, -l).translate(-f, -b).multiply(p), n && (g = g.rotate(n)), u && (g = g.scale(-1, 1)), m && (g = g.scale(1, -1));
				for (let Q of J) Q !== "e" && Q !== "f" && (g[Q] > this.minScale + 1e-5 || g[Q] < this.minScale - 1e-5) ? this.target[Q] = g[Q] : this.target[Q] = F(g[Q], It);
				(this.targetScale < this.scale || Math.abs(i - 1) > .1 || this.panMode === D || r === !1) && !s && this.clampTargetBounds(), d === w.Init ? this.animate() : this.isResting || (this.state = w.Panning, this.requestTick())
			}
			stop(t = !1) {
				if (this.state === w.Init || this.state === w.Destroy) return;
				let e = this.isTicking;
				this.rAF && (cancelAnimationFrame(this.rAF), this.rAF = null), this.isBouncingX = !1, this.isBouncingY = !1;
				for (let i of J) this.velocity[i] = 0, t === "current" ? this.current[i] = this.target[i] : t === "target" && (this.target[i] = this.current[i]);
				this.setTransform(), U(this.container, "is-scaling"), U(this.container, "is-animating"), this.isTicking = !1, this.state = w.Ready, e && (this.emit("endAnimation"), this.updateControls())
			}
			requestTick() {
			...
			panWithMouse(t, e = this.option("mouseMoveFriction")) {
				if (this.pmme = t, this.panMode !== D || !t || F(this.targetScale) <= F(this.minScale)) return;
				this.emit("mouseMove", t);
				let {
					container: i,
					containerRect: n,
					contentRect: o
				} = this, l = n.width, c = n.height, u = i.getBoundingClientRect(), m = (t.clientX || 0) - u.left, s = (t.clientY || 0) - u.top, {
					contentWidth: r,
					contentHeight: d
				...
				b += .5 * (o.bottom - o.top), this.applyChange({
			...
			zoomWithWheel(t) {
				...
				let n = Math.max(-1, Math.min(1, i)),
					...
					u = o * (100 + 45 * n) / 100;
				F(u) < F(c) && F(o) <= F(c) ? (this.cwd += Math.abs(n), u = c) : F(u) > F(l) && F(o) >= F(l) ? (this.cwd += Math.abs(n), u = l) : (this.cwd = 0, u = Math.max(Math.min(u, l), c)), this.cwd > this.option("wheelLimit") || (t.preventDefault(), F(u) !== F(o) && this.zoomTo(u, {
					event: t
				}))
			}
			canZoomIn() {
			...
			zoomTo(t = 1, {
				...
				if (this.stop(), this.panMode === D && (o = this.pmme || o), o || i === X || n === X) {
					let r = this.content.getBoundingClientRect(),
						d = this.container.getBoundingClientRect(),
						h = o ? o.clientX : d.left + .5 * d.width,
						f = o ? o.clientY : d.top + .5 * d.height;
					i = h - r.left - .5 * r.width, n = f - r.top - .5 * r.height
				}
				let s = 1;
				typeof t == "number" ? s = t : t === "full" ? s = c : t === "cover" ? s = m : t === "max" ? s = u : t === "fit" ? s = 1 : t === "next" && (s = this.getNextScale("iterateZoom")), s = s / l || 1, e = e === X ? s > 1 ? .15 : .25 : e, this.applyChange({
					scale: s,
					originX: i,
					originY: n,
					friction: e
			...
			reset(t) {
				if (this.state !== w.Init && this.state !== w.Destroy) {
					...
					this.target.a = this.minScale, this.target.d = this.minScale, this.clampTargetBounds(), this.isResting || (this.friction = t === void 0 ? this.option("friction") : t, this.state = w.Panning, this.requestTick())
				}
			}
			destroy() {
				this.stop(), this.state = w.Destroy, this.detachEvents(), this.detachObserver();
				let {
					container: t,
					content: e
	...
	var vi = function(a, t) {
		...
		Z;
	(function(a) {
		a[a.Init = 0] = "Init", a[a.Ready = 1] = "Ready", a[a.Destroy = 2] = "Destroy"
	})(Z || (Z = {}));
	var Oe = a => {
			if (typeof a == "string" || a instanceof HTMLElement) a = {
				html: a
			};
			else {
				let t = a.thumb;
				t !== void 0 && (typeof t == "string" && (a.thumbSrc = t), t instanceof HTMLImageElement && (a.thumbEl = t, a.thumbElSrc = t.src, a.thumbSrc = t.src), delete a.thumb)
			}
		...
		zt = class extends Y {
			...
			refresh() {
				...
				for (let r of[...u.children]) {
					...
					d && (m = r), z(r, this.cn("isCurrent"), d), (t = r.children[0]) === null || t === void 0 || t.setAttribute("aria-selected", d ? "true" : "false");
					for (let h of["isBeforePrev", "isPrev", "isNext", "isAfterNext"]) U(r, this.cn(h));
					s++
				}
			...
			cleanup() {
				this.list && (this.list.remove(), this.list = null), this.isDynamic = !1, U(this.instance.container, this.cn("hasDots"))
			}
			attach() {
	...
	var Rt = "disabled",
		...
		jt = class extends Y {
			...
			onRefresh() {
				...
				let n = this.prev,
					o = this.next;
				n && o && (n.removeAttribute(Rt), o.removeAttribute(Rt), t.isInfinite || (i <= 0 && n.setAttribute(Rt, ""), i >= e - 1 && o.setAttribute(Rt, "")))
			}
			addBtn(t) {
				var e;
				let i = this.instance,
					n = document.createElement("button");
				n.setAttribute("tabindex", "0"), n.setAttribute("title", i.localize(`{{${t.toUpperCase()}}}`)), v(n, this.cn("button") + " " + this.cn(t === Vt ? "isNext" : "isPrev"));
				let o = i.isRTL ? t === Vt ? xi : Vt : t;
				var l;
				return n.innerHTML = i.localize(this.option(`${o}Tpl`)), n.dataset[`carousel${l=t,l?l.match("^[a-z]")?l.charAt(0).toUpperCase()+l.substring(1):l:""}`] = "true", (e = this.container) === null || e === void 0 || e.appendChild(n), n
			}
			build() {
				...
				i || (i = t.querySelector("." + e), this.isDom = !!i), i || (i = document.createElement("div"), v(i, e), t.appendChild(i)), this.container = i, o || (o = i.querySelector("[data-carousel-next]")), o || (o = this.addBtn(Vt)), this.next = o, n || (n = i.querySelector("[data-carousel-prev]")), n || (n = this.addBtn(xi)), this.prev = n
			}
			cleanup() {
	...
	var Jt = class extends Y {
		...
		attachEvents() {
			...
			t && e && (t.options.initialSlide = e.options.initialPage, t.state === Z.Ready ? this.onNavReady(t) : t.on("ready", this.onNavReady), e.state === Z.Ready ? this.onTargetReady(e) : e.on("ready", this.onTargetReady))
		}
		onNavReady(t) {
		...
		onTargetChange() {
			...
			this.markSelectedSlide(o), n.slideTo(l, n.prevPage === null && i.prevPage === null ? {
				friction: 0
			} : void 0)
		}
		markSelectedSlide(t) {
			let e = this.nav;
			e && e.state === Z.Ready && (this.selectedIndex = t, [...e.slides].map(i => {
	...
	var ds = {
		...
		Ui = "isSelected",
		_t = "slide",
		dt = class a extends yt {get axis() {
			...
			get isEnabled() {
				...
				let t = !1,
					...
					l = o[0];
				return n.length >= 2 && l && e + l.dim >= i && (t = this.option("infinite")), t
			}
			get isRTL() {
			...
			constructor(t, e = {}, i = {}) {
				if (super(), Object.defineProperty(this, "bp", {
						...
						writable: !0,
						value: 0
					}), typeof t == "string" && (t = document.querySelector(t)), !t || !R(t)) throw new Error("No Element found");
				this.container = t, this.slideNext = vi(this.slideNext.bind(this), 150), this.slidePrev = vi(this.slidePrev.bind(this), 150), this.userOptions = e, this.userPlugins = i, queueMicrotask(() => {
					this.processOptions()
				})
			}
			processOptions() {
				...
				let i = V({}, a.defaults, this.userOptions),
					...
					o = i.breakpoints;
				if (o && je(o))
					for (let [l, c] of Object.entries(o)) window.matchMedia(l).matches && je(c) && (n += l, V(i, c));
				n === this.bp && this.state !== Z.Init || (this.bp = n, this.state === Z.Ready && (i.initialSlide = ((e = (t = this.pages[this.page]) === null || t === void 0 ? void 0 : t.slides[0]) === null || e === void 0 ? void 0 : e.index) || 0), this.state !== Z.Init && this.destroy(), super.setOptions(i), this.option("enabled") === !1 ? this.attachEvents() : setTimeout(() => {
					this.init()
				}, 0))
			}
			init() {
				this.state = Z.Init, this.emit("init"), this.attachPlugins(Object.assign(Object.assign({}, a.Plugins), this.userPlugins)), this.emit("attachPlugins"), this.initLayout(), this.initSlides(), this.updateMetrics(), this.setInitialPosition(), this.initPanzoom(), this.attachEvents(), this.state = Z.Ready, this.emit("ready")
			}
			initLayout() {
				let {
					container: t
				} = this, e = this.option("classes");
				v(t, this.cn("container")), z(t, e.isLTR, !this.isRTL), z(t, e.isRTL, this.isRTL), z(t, e.isVertical, !this.isHorizontal), z(t, e.isHorizontal, this.isHorizontal);
				let i = this.option("viewport") || t.querySelector(`.${e.viewport}`);
				i || (i = document.createElement("div"), v(i, e.viewport), i.append(...Bi(t, `.${e.slide}`)), t.prepend(i)), i.addEventListener("scroll", this.onScroll);
				let n = this.option("track") || t.querySelector(`.${e.track}`);
				n || (n = document.createElement("div"), v(n, e.track), n.append(...Array.from(i.childNodes))), n.setAttribute("aria-live", "polite"), i.contains(n) || i.prepend(n), this.viewport = i, this.track = n, this.emit("initLayout")
			}
			initSlides() {
				let {
					track: t
				...
				for (let n of[...this.option("slides", []) || [], ...e]) i.push(Oe(n));
				this.slides = i;
				for (let n = 0; n < this.slides.length; n++) this.slides[n].index = n;
				for (let n of i) this.emit("beforeInitSlide", n, n.index), this.emit("initSlide", n, n.index);
			...
			createPages() {
				...
				let o = 0,
					l = 0,
					c = 0;
				for (let u of this.slides)(!t.length || l + u.dim - i > .05 || c >= n) && (t.push(ls()), o = t.length - 1, l = 0, c = 0), t[o].slides.push(u), l += u.dim + u.gap, c++;
				return t
			}
			processPages() {
				let t = this.pages,
				...
				if (t.forEach((s, r) => {
						...
						for (let [h, f] of s.slides.entries()) s.dim += f.dim, h < s.slides.length - 1 && (s.dim += f.gap);
						c && s.pos + .5 * s.dim < .5 * i ? s.pos = 0 : c && s.pos + .5 * s.dim >= e - .5 * i ? s.pos = e - i : o && (s.pos += -.5 * (i - s.dim))
					}), t.forEach(s => {
						l && !n && e > i && (s.pos = Math.max(s.pos, 0), s.pos = Math.min(s.pos, e - i)), s.pos = F(s.pos, 1e3), s.dim = F(s.dim, 1e3), Math.abs(s.pos) <= .1 && (s.pos = 0)
					}), n) return t;
				let u = [],
					m;
				return t.forEach(s => {
			...
			getSlideMetrics(t) {
				...
				let n = this.isHorizontal ? "width" : "height",
					...
					c = t.el,
					u = !(!c || c.parentNode);
				if (c ? o = parseFloat(c.dataset[n] || "") || 0 : (c = document.createElement("div"), c.style.visibility = "hidden", (this.track || document.body).prepend(c)), v(c, this.cn(_t) + " " + t.class + " " + t.customClass), o) c.style[n] = `${o}px`, c.style[n === "width" ? "height" : "width"] = "";
				else {
					u && (this.track || document.body).prepend(c), o = c.getBoundingClientRect()[n] * Math.max(1, ((e = window.visualViewport) === null || e === void 0 ? void 0 : e.scale) || 1);
					let s = c[this.isHorizontal ? "offsetWidth" : "offsetHeight"];
					s - 1 > o && (o = s)
				}
				let m = getComputedStyle(c);
				return m.boxSizing === "content-box" && (this.isHorizontal ? (o += parseFloat(m.paddingLeft) || 0, o += parseFloat(m.paddingRight) || 0) : (o += parseFloat(m.paddingTop) || 0, o += parseFloat(m.paddingBottom) || 0)), l = parseFloat(m[this.isHorizontal ? "marginRight" : "marginBottom"]) || 0, u ? (i = c.parentElement) === null || i === void 0 || i.removeChild(c) : t.el || c.remove(), {
					dim: F(o, 1e3),
					gap: F(l, 1e3)
				}
			}
			...
			repositionSlides() {
				let t, {
					...
					f = 0,
					b = 0;
				r ? b = -1 * r.current[this.axis] : m[u] && (b = m[u].pos || 0), t = e ? i ? "right" : "left" : "top", i && e && (b *= -1);
				for (let y of s) {
					let B = y.el;
					B ? (t === "top" ? (B.style.right = "", B.style.left = "") : B.style.top = "", y.index !== d ? B.style[t] = h === 0 ? "" : `${F(h,1e3)}px` : B.style[t] = "", f += y.dim + y.gap, d++) : h += y.dim + y.gap
				}
				if (n && f && o) {
					...
					for (let W of s) W.el && (F(W.pos) < F(l) && F(W.pos + W.dim + W.gap) < F(b) && F(b) > F(c - l) && (W.el.style[t] = `${F(h+f,1e3)}px`), F(W.pos + W.gap) >= F(c - l) && F(W.pos) > F(b + l) && F(b) < F(l) && (W.el.style[t] = `-${F(f,1e3)}px`))
				}
				let p, g, Q = [...this.inTransition];
				if (Q.length > 1 && (p = m[Q[0]], g = m[Q[1]]), p && g) {
					let y = 0;
					for (let B of s) B.el ? this.inTransition.has(B.index) && p.slides.indexOf(B) < 0 && (B.el.style[t] = `${F(y+(p.pos-g.pos),1e3)}px`) : y += B.dim + B.gap
				}
			}
			createSlideEl(t) {
				let {
				...
				e.insertBefore(n, e.contains(m) ? m : null), t.el = n, this.emit("createSlide", t)
			}
			removeSlideEl(t, e = !1) {
				let i = t ? .el;
				if (!i || !i.parentNode) return;
				let n = this.cn(Ui);
				if (i.classList.contains(n) && (U(i, n), this.emit("unselectSlide", t)), t.isDom && !e) return i.removeAttribute("aria-hidden"), i.removeAttribute("data-index"), void(i.style.left = "");
			...
			transitionTo(t = 0, e = this.option("transition")) {
				...
				if (!m || !u[s] || u.length < 2 || Math.abs((((n = (i = u[c]) === null || i === void 0 ? void 0 : i.slides[0]) === null || n === void 0 ? void 0 : n.dim) || 0) - this.viewportDim) > 1) return !1;
				let r = t > c ? 1 : -1;
				...
				return p && (this.inTransition.add(f.index), f.transition = e, p.addEventListener(Yt, this.onAnimationEnd), p.classList.add(`f-${e}Out`, `to-${r>0?y:Q}`)), g && (b.transition = e, g.addEventListener(Yt, this.onAnimationEnd), g.classList.add(`f-${e}In`, `from-${r>0?Q:y}`)), m.current[this.axis] = d, m.target[this.axis] = d, m.requestTick(), this.onChange(s), !0
			}
			...
			markSelectedSlides() {
				...
				if (e)
					for (let i of this.slides) {
						let n = i.el;
						n && (n.dataset.index = `${i.index}`, n.classList.contains("f-thumbs__slide") ? this.getVisibleSlides(0).has(i) ? n.removeAttribute(t) : n.setAttribute(t, "true") : this.pages[this.page].slides.includes(i) ? (n.classList.contains(e) || (v(n, e), this.emit("selectSlide", i)), n.removeAttribute(t)) : (n.classList.contains(e) && (U(n, e), this.emit("unselectSlide", i)), n.setAttribute(t, "true")))
					}
			}
			flipInfiniteTrack() {
				let {
				...
				let u = c.current[t],
					...
					s = 0,
					r = .5 * o;
				n && e ? (u < -r && (s = -1, u += l), u > l - r && (s = 1, u -= l)) : (u > r && (s = 1, u -= l), u < -l + r && (s = -1, u += l)), s && (c.current[t] = u, c.target[t] = u + m)
			}
			lazyLoadImg(t, e) {
				let i = this,
					n = "f-fadeIn",
					...
					c = null,
					u = () => {
						l || (l = !0, c && (c.remove(), c = null), U(e, o), e.complete && (v(e, n), setTimeout(() => {
							U(e, n)
				...
				v(e, o), e.src = e.dataset.lazySrcset || e.dataset.lazySrc || "", delete e.dataset.lazySrc, delete e.dataset.lazySrcset, e.addEventListener("error", () => {
					u()
				}), e.addEventListener("load", () => {
					u()
				}), setTimeout(() => {
					let m = e.parentNode;
					m && t.el && (e.complete ? u() : l || (c = S(Pe), m.insertBefore(c, e)))
				}, 300)
			}
			lazyLoadSlide(t) {
				let e = t && t.el;
				...
				e.dataset.lazySrc && n.push(e), n.map(o => {
					o instanceof HTMLImageElement ? i.add(o) : o instanceof HTMLElement && o.dataset.lazySrc && (o.style.backgroundImage = `url('${o.dataset.lazySrc}')`, delete o.dataset.lazySrc)
				});
			...
			onAnimationEnd(t) {
				...
				c && l.substring(0, c.length + 2) === `f-${c}` && this.inTransition.delete(n), this.inTransition.size || this.clearTransitions(), n === this.page && (!((e = this.panzoom) === null || e === void 0) && e.isResting) && this.emit("settle")
			}
			onDecel(t, e = 0, i = 0, n = 0, o = 0) {
				...
				let {
					...
					axis: u,
					pages: m
				} = this, s = m.length, r = Math.abs(Math.atan2(i, e) / (Math.PI / 180)), d = 0;
				...
				Math.abs(d) > 5 ? (m[h].dim < document.documentElement["client" + (this.isHorizontal ? "Width" : "Height")] - 1 && (h = p), h = l && c ? d < 0 ? h - 1 : h + 1 : d < 0 ? h + 1 : h - 1) : h = n === 0 && o === 0 ? h : p, this.slideTo(h, {
					transition: !1,
			...
			onClick(t) {
				let e = t.target,
					...
					n, o;
				i && (i.carouselPage !== void 0 ? (o = "slideTo", n = i.carouselPage) : i.carouselNext !== void 0 ? o = "slideNext" : i.carouselPrev !== void 0 && (o = "slidePrev")), o ? (t.preventDefault(), t.stopPropagation(), e && !e.hasAttribute("disabled") && this[o](n)) : this.emit("click", t)
			}
			onSlideTo(t) {
				let e = t.detail || 0;
			...
			reInit(t = null, e = null) {
				this.destroy(), this.state = Z.Init, this.prevPage = null, this.userOptions = t || this.userOptions, this.userPlugins = e || this.userPlugins, this.processOptions()
			}
			slideTo(t = 0, {
				...
				d *= r, Math.abs(m.target[o] - d) < 1 || (m.panTo({
					x: l ? d : 0,
					y: l ? 0 : d,
					friction: e
				}), this.onChange(n))
			...
			clearTransitions() {
				...
				for (let e of this.slides) {
					let i = e.el;
					if (i) {
						i.removeEventListener(Yt, this.onAnimationEnd), i.classList.remove(...t);
						let n = e.transition;
			...
			addSlide(t, e) {
				...
				if (this.page >= t && (this.page += d.length), this.updateMetrics(), c) {
					...
					s && b === 1 ? (t <= this.page && (c.current[this.axis] -= p, c.target[this.axis] -= p), c.panTo({
						[this.isHorizontal ? "x" : "y"]: -1 * h
					})) : g && t <= this.page && (c.target[this.axis] -= g, c.current[this.axis] -= g, c.requestTick())
				}
			...
			updateMetrics() {
				...
				if (e) {
					let r = Math.max(e[u], F(e.getBoundingClientRect()[c], 1e3)),
						...
						h = "padding",
						f = o ? "Right" : "Bottom";
					r -= parseFloat(d[h + (o ? "Left" : "Top")]) + parseFloat(d[h + f]), this.viewportDim = r
				}
				let m, s = 0;
				for (let [r, d] of n.entries()) {
					let h = 0,
						f = 0;
					!d.el && m ? (h = m.dim, f = m.gap) : ({
						dim: h,
						gap: f
					} = this.getSlideMetrics(d), m = d), h = F(h, 1e3), f = F(f, 1e3), d.dim = h, d.gap = f, d.pos = s, s += h, (l || r < n.length - 1) && (s += f)
				}
				s = F(s, 1e3), this.contentDim = s, t && (t.contentRect[c] = s, t.contentRect[o ? "fullWidth" : "fullHeight"] = s), this.pages = this.createPages(), this.pages = this.processPages(), this.state === Z.Init && this.setInitialPage(), this.page = Math.max(0, Math.min(this.page, this.pages.length - 1)), this.manageSlideVisiblity(), this.emit("refresh")
			}
			getProgress(t, e = !1, i = !1) {
				...
				let u = -1 * o.current.e,
					...
					s = m,
					r = m;
				this.isInfinite && i !== !0 && (s = F((u - c.pos + l) / (1 * c.dim), 1e3), r = F((u - c.pos - l) / (1 * c.dim), 1e3));
			...
			setViewportHeight() {
				...
				if (!i || !e[t]) return;
				let o = 0;
				n && this.track && (this.track.style.height = "auto", e[t].slides.forEach(l => {
			...
			getVisibleSlides(t = 0) {
				...
				if (l) {
					...
					let m = 0;
					m = n && n.state !== w.Init && n.state !== w.Destroy ? -1 * n.current[this.axis] : c[u] && c[u].pos || 0, this.isInfinite && (m -= Math.floor(m / o) * o), this.isRTL && this.isHorizontal && (m *= -1);
					let s = m - l * t,
						r = m + l * (t + 1),
			...
			getPageFromPosition(t) {
				let {
					...
					pages: o,
					panzoom: l
				} = this, c = o.length, u = n.length, m = n[0], s = n[u - 1], r = this.option("center"), d = 0, h = 0, f = 0, b = t === void 0 ? -1 * (l ? .target[this.axis] || 0) : t;
				r && (b += .5 * e), this.isInfinite ? (b < m.pos - .5 * s.gap && (b -= i, f = -1), b > s.pos + s.dim + .5 * s.gap && (b -= i, f = 1)) : b = Math.max(m.pos || 0, Math.min(b, s.pos));
				let p = s,
					g = n.find(Q => {
						let y = Q.pos - .5 * p.gap,
				...
				return g || (g = s), h = this.getPageForSlide(g.index), d = h + f * c, {
					page: d,
					pageIndex: h
				}
			}
			...
			destroy() {
				...
				t.removeEventListener("click", this.onClick, {
					passive: !1,
					capture: !1
				}), t.removeEventListener("slideTo", this.onSlideTo), window.removeEventListener("resize", this.onResize), o && (o.destroy(), this.panzoom = null), n && n.forEach(u => {
	...
	var zi = function(a) {
		...
		Ft = !(typeof window > "u" || !window.document || !window.document.createElement),
		Me, Ie = ["a[href]", "area[href]", 'input:not([disabled]):not([type="hidden"]):not([aria-hidden])', "select:not([disabled]):not([aria-hidden])", "textarea:not([disabled]):not([aria-hidden])", "button:not([disabled]):not([aria-hidden]):not(.fancybox-focus-guard)", "iframe", "object", "embed", "video", "audio", "[contenteditable]", '[tabindex]:not([tabindex^="-"]):not([disabled]):not([aria-hidden])'].join(","),
		wi = a => {
			if (a && Ft) {
				Me === void 0 && document.createElement("div").focus({get preventScroll() {
						return Me = !0, !1
					}
				});
				try {
					if (Me) a.focus({
						...
						a.focus(), document.body.scrollTo({
							top: t,
							left: e,
							behavior: "auto"
						})
		...
		ji = () => {
			let a = document,
				...
				i = "",
				n = "";
			return a.fullscreenEnabled ? (e = "requestFullscreen", i = "exitFullscreen", n = "fullscreenElement") : a.webkitFullscreenEnabled && (e = "webkitRequestFullscreen", i = "webkitExitFullscreen", n = "webkitFullscreenElement"), e && (t = {
    ...
    <div class="fancybox__footer"></div>
		...
		O, I;
	(function(a) {
		a[a.Init = 0] = "Init", a[a.Ready = 1] = "Ready", a[a.Closing = 2] = "Closing", a[a.CustomClosing = 3] = "CustomClosing", a[a.Destroy = 4] = "Destroy"
	})(O || (O = {})),
	function(a) {
		a[a.Loading = 0] = "Loading", a[a.Opening = 1] = "Opening", a[a.Ready = 2] = "Ready", a[a.Closing = 3] = "Closing"
	}(I || (I = {}));
	var Li = "",
		Qt = !1,
		Dt = !1,
		...
		Ji = () => {
			...
			if (e) {
				...
				if (i && n) {
					...
					t = o || e.option("slug") || "", !t && l && l.dataset && (t = l.dataset.fancybox || ""), t && t !== "true" && (a = "#" + t + (!o && i.slides.length > 1 ? "-" + (n.index + 1) : ""))
				}
			}
			return {
				hash: a,
		...
		Ki = () => {
			it && clearTimeout(it), queueMicrotask(() => {
				Pi()
			})
		},
		Wi = () => {
			window.addEventListener("hashchange", Ki, !1), setTimeout(() => {
				Pi()
			}, 500)
		};
	...
	var Xt = "is-zooming-in",
		Pt = class extends Y {
			...
			onClose() {
				...
				if (!o || !u || !l || !c || c.isContentLoading || c.state === w.Init || c.state === w.Destroy) return;
				c.updateMetrics();
				let m = this.getZoomInfo(n);
				if (!m) return;
				this.instance.state = O.CustomClosing, i.classList.remove(Xt), i.classList.add("is-zooming-out"), l.style.backgroundImage = `url('${u}')`;
			...
			setImage(t, e) {
				let i = this.instance;
				t.src = e, this.process(t, e).then(n => {
					let {
						contentEl: o,
						imageEl: l,
						thumbElSrc: c,
					...
					if (c && m) {
						let r = n.contentRect,
							...
							h = null;
						!m.opacity && d > 1200 && (h = document.createElement("img"), v(h, "fancybox-ghost"), h.src = c, o.appendChild(h));
						let f = () => {
						...
						(s = c, new Promise((b, p) => {
							...
							i.hideLoading(t), t.state = I.Opening, this.instance.emit("reveal", t), this.zoomIn(t).then(() => {
						...
						let r = this.optionFor(t, "initialSize"),
							...
							b = !0;
						i.isOpeningSlide(t) && (r === "full" ? n.zoomToFull(h) : r === "cover" ? n.zoomToCover(h) : r === "max" ? n.zoomToMax(h) : b = !1, n.stop("current")), b && f && (f = n.isDragging ? "f-fadeIn" : ""), i.hideLoading(t), i.revealContent(t, f)
					}
					var s
				}, () => {
				...
				return new Promise((i, n) => {
					...
					if (typeof u == "string" && (u = S(u)), !u || !R(u)) {
						if (u = document.createElement("img"), u instanceof HTMLImageElement) {
							let m = "",
								s = t.caption;
							m = typeof s == "string" && s ? s.replace(/<[^>]+>/gi, "").substring(0, 1e3) : `Image ${t.index+1} of ${((o=l.carousel)===null||o===void 0?void 0:o.pages.length)||1}`, u.src = e || "", u.alt = m, u.draggable = !1, t.srcset && u.setAttribute("srcset", t.srcset), this.instance.isOpeningSlide(t) && (u.fetchPriority = "high")
						}
						t.sizes && u.setAttribute("sizes", t.sizes)
					}
					v(u, "fancybox-image"), t.imageEl = u, l.setContent(t, u, !1), t.panzoom = new st(c, V({
						transformParent: !0
					}, this.option("Panzoom") || {}, {
						content: u,
			...
			zoomIn(t) {
				return new Promise((e, i) => {
					...
					let {
						...
						t.state !== I.Closing && (h && (c.style.opacity = Math.max(Math.min(1, 1 - (1 - l.scale) / (1 - d)), 0) + ""), l.scale >= 1 && l.scale > l.targetScale - .1 && e(l))
					}, b = Q => {
						(Q.scale < .99 || Q.scale > 1.01) && !Q.isDragging || (U(o, Xt), c.style.opacity = "", Q.off("endAnimation", b), Q.off("touchStart", b), Q.off("afterTransform", f), e(Q))
					};
					l.on("endAnimation", b), l.on("touchStart", b), l.on("afterTransform", f), l.on(["error", "destroy"], () => {
						i()
					}), l.panTo({
						x: s,
						y: r,
					...
					v(o, Xt), n.hideLoading(t), g === "full" ? l.zoomToFull(p) : g === "cover" ? l.zoomToCover(p) : g === "max" ? l.zoomToMax(p) : l.reset(.172)
				})
			}
			getZoomInfo(t) {
				let {
				...
				if (!e || !i || !n || !o || zi(n) < 3 || !this.optionFor(t, "zoom") || !c || l.state === O.Destroy || getComputedStyle(c).getPropertyValue("--f-images-zoom") === "0") return !1;
  ...
  <source src="{{src}}" type="{{format}}" />Sorry, your browser doesn't support embedded videos.</video>`,
		...
		Kt = class extends Y {
			...
			onClearContent(t, e) {
				...
				let n = e.contentEl,
					o = e.placeholderEl;
				if (e.type === "inline" && n && o) n.classList.remove("fancybox__content"), getComputedStyle(n).getPropertyValue("display") !== "none" && (n.style.display = "none"), setTimeout(() => {
					o && (n && o.parentNode && o.parentNode.insertBefore(n, o), o.remove())
			...
			onUnselectSlide(t, e, i) {
				...
				i.type === q ? l = {
					...
					event: "command",
					func: "pauseVideo"
				}), l && i.iframeEl && i.iframeEl.contentWindow && i.iframeEl.contentWindow.postMessage(JSON.stringify(l), "*"), i.poller && clearTimeout(i.poller)
			}
			onDone(t, e) {
			...
			onMessage(t) {
				try {
					...
					if (t.origin === "https://player.vimeo.com") {
						if (e.event === "ready")
							for (let i of Array.from(document.getElementsByClassName("fancybox__iframe"))) i instanceof HTMLIFrameElement && i.contentWindow === t.source && (i.dataset.ready = "true")
			...
			loadAjaxContent(t) {
				...
				i.showLoading(t), n.onreadystatechange = function() {
					n.readyState === XMLHttpRequest.DONE && i.state === O.Ready && (i.hideLoading(t), n.status === 200 ? i.setContent(t, n.responseText) : i.setError(t, n.status === 404 ? "{{AJAX_NOT_FOUND}}" : "{{AJAX_FORBIDDEN}}"))
				};
				let o = t.ajax || null;
				n.open(o ? "POST" : "GET", e + ""), n.setRequestHeader("Content-Type", "application/x-www-form-urlencoded"), n.setRequestHeader("X-Requested-With", "XMLHttpRequest"), n.send(o), t.xhr = n
			}
			setInlineContent(t) {
				let e = null;
				if (R(t.src)) e = t.src;
			...
			setIframeContent(t) {
				...
				o.className = "fancybox__iframe", o.setAttribute("id", `fancybox__iframe_${n.id}_${t.index}`);
				for (let [c, u] of Object.entries(this.optionFor(t, "iframeAttr") || {})) o.setAttribute(c, u);
				o.onerror = () => {
					n.setError(t, "{{IFRAME_ERROR}}")
				}, t.iframeEl = o;
				let l = this.optionFor(t, "preload");
				if (t.type !== "iframe" || l === !1) return o.setAttribute("src", t.src + ""), n.setContent(t, o, !1), this.resizeIframe(t), void n.revealContent(t);
				n.showLoading(t), o.onload = () => {
					if (!o.src.length) return;
					let c = o.dataset.ready !== "true";
					o.dataset.ready = "true", this.resizeIframe(t), c ? n.revealContent(t) : n.hideLoading(t)
				}, o.setAttribute("src", e), n.setContent(t, o, !1)
			}
			resizeIframe(t) {
				let {
					type: e,
				...
				if (t.preload !== !1 && o !== !1 && u) try {
					...
					if (d) {
						let h = d.document,
							...
							b = h.body;
						u.width = "", b.style.overflow = "hidden", l = l || f.scrollWidth + s, u.width = `${l}px`, b.style.overflow = "", u.flex = "0 0 auto", u.height = `${b.scrollHeight}px`, c = f.scrollHeight + r
					}
				} catch {}
				if (l || c) {
					let m = {
			...
			playVideo() {
				...
				let i = () => {
					if (t.iframeEl && t.iframeEl.contentWindow) {
						let n;
						if (t.iframeEl.dataset.ready === "true") return n = t.type === H ? {
							event: "command",
							func: "playVideo"
						} : {
							method: "play",
			...
			processType(t) {
				...
				if (n = e.match(/(youtube\.com|youtu\.be|youtube\-nocookie\.com)\/(?:watch\?(?:.*&)?v=|v\/|u\/|shorts\/|embed\/?)?(videoseries\?list=(?:.*)|[\w-]{11}|\?listType=(?:.*)&list=(?:.*))(?:.*)/i)) {
					let o = this.optionFor(t, H),
						...
						c = function(r, d) {
							var h = {};
							for (var f in r) Object.prototype.hasOwnProperty.call(r, f) && d.indexOf(f) < 0 && (h[f] = r[f]);
							if (r != null && typeof Object.getOwnPropertySymbols == "function") {
								var b = 0;
								for (f = Object.getOwnPropertySymbols(r); b < f.length; b++) d.indexOf(f[b]) < 0 && Object.prototype.propertyIsEnumerable.call(r, f[b]) && (h[f[b]] = r[f[b]])
							}
							return h
						}(o, ["nocookie"]),
					...
					t.videoId = s, t.src = `https://${u}/embed/${s}?${m}`, t.thumbSrc = t.thumbSrc || `https://i.ytimg.com/vi/${s}/mqdefault.jpg`, i = H
				} else if (n = e.match(/^.+vimeo.com\/(?:\/)?([\d]+)((\/|\?h=)([a-z0-9]+))?(.*)?/)) {
					let o = Ei(e, this.optionFor(t, q)),
						l = encodeURIComponent(n[1]),
						c = n[4] || "";
					t.videoId = l, t.src = `https://player.vimeo.com/video/${l}?${c?`
					h = $ {
						c
					}
					$ {
				...
				i || typeof e == "string" && (e.charAt(0) === "#" ? i = "inline" : (n = e.match(/\.(mp4|mov|ogv|webm)((\?|#).*)?$/i)) ? (i = bt, t.videoFormat = t.videoFormat || "video/" + (n[1] === "ogv" ? "ogg" : n[1])) : e.match(/(^data:image\/[a-z0-9+\/=]*,)|(\.(jp(e|g|eg)|gif|png|bmp|webp|svg|ico)((\?|#).*)?$)/i) ? i = Ci : e.match(/\.(pdf)((\?|#).*)?$/i) && (i = "pdf")), (n = e.match(/(?:maps\.)?google\.([a-z]{2,3}(?:\.[a-z]{2})?)\/(?:(?:(?:maps\/(?:place\/(?:.*)\/)?\@(.*),(\d+.?\d+?)z))|(?:\?ll=))(.*)?/i)) ? (t.src = `https://maps.google.${n[1]}/?ll=${(n[2]?n[2]+"&z="+Math.floor(parseFloat(n[3]))+(n[4]?n[4].replace(/^\//,"&"):""):n[4]+"").replace(/\?/,"&")}&output=${n[4]&&n[4].indexOf("layer=c")>0?"svembed":"embed"}`, i = Ve) : (n = e.match(/(?:maps\.)?google\.([a-z]{2,3}(?:\.[a-z]{2})?)\/(?:maps\/search\/)(.*)/i)) && (t.src = `https://maps.google.${n[1]}/maps?q=${n[2].replace("query=","q=").replace("api=1","")}&output=embed`, i = Ve), i = i || this.instance.option("defaultType"), t.type = i, i === Ci && (t.thumbSrc = t.thumbSrc || t.src)
			}
			setContent(t) {
				let e = this.instance.optionFor(t, "src") || "";
				if (t && t.type && e) {
			...
			setAspectRatio(t) {
				...
				let l = e.getBoundingClientRect(),
					c = l.width || 1,
					u = l.height || 1;
				e.style.aspectRatio = i + "", i < c / u ? (o = o === "auto" ? u : Math.min(u, o), e.style.width = "auto", e.style.height = `${o}px`) : (n = n === "auto" ? c : Math.min(c, n), e.style.width = `${n}px`, e.style.height = "auto")
			}
			attach() {
				let t = this,
					e = t.instance;
	...
	var Gt = "play",
		...
		$t = class extends Y {
			...
			createProgressBar() {
				...
				if (n || (n = (i.length === 1 ? i[0].el : null) || e.viewport), !n) return null;
				let o = document.createElement("div");
				return v(o, "f-progress"), n.prepend(o), this.progressBar = o, o.offsetHeight, o
			}
			set() {
				let t = this,
					e = t.instance;
			...
			stop() {
				...
				t.clear(), t.state = gt, i.removeEventListener("mouseenter", t.onMouseEnter, !1), i.removeEventListener("mouseleave", t.onMouseLeave, !1), document.removeEventListener("visibilitychange", t.onVisibilityChange, !1), U(i, "has-autoplay"), e !== gt && t.emit("stop")
			}
			pause() {
				let t = this;
		...
		onPrepare(t) {
			...
			i && (e.options.Autoplay = V({
				...
				on: {
					...
					set: n => {
						var o;
						i.classList.add("has-slideshow"), ((o = t.getSlide()) === null || o === void 0 ? void 0 : o.state) !== I.Ready && n.pause()
					},
					stop: () => {
	...
	var $i = {
		...
		P;
	(function(a) {
		a[a.Init = 0] = "Init", a[a.Ready = 1] = "Ready", a[a.Hidden = 2] = "Hidden"
	})(P || (P = {}));
	var Zi = "isResting",
		Tt = "thumbWidth",
		at = "thumbHeight",
		...
		qi = class extends Y {
			...
			onInitSlide(a, t) {
				...
				e && (t.thumbSrc = e.thumbSrc || t.thumbSrc || "", t[A] = parseFloat(e[A] || "") || t[A] || 0, t[at] = parseFloat(e.thumbHeight || "") || t[at] || 0), this.addSlide(t)
			}
			onInitSlides() {
				this.build()
			}
			onChange() {
				...
				if (i && n && o) {
					if (i.isDragging) {
						...
						let u = o.getBounds(); - 1 * c > u.x.min && -1 * c < u.x.max && o.panTo({
							x: -1 * c,
							friction: .12
						})
			...
			getThumb(a) {
				...
				return {
					html: this.instance.localize(t, [
						["%i", a.index],
						["%d", a.index + 1],
						["%s", a.thumbSrc || "data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7"]
					])
				}
			}
			addSlide(a) {
			...
			updateProps() {
				...
				this.thumbGap = t("gap"), this.thumbExtraGap = t("extra-gap"), this[Tt] = t("width") || 40, this[A] = t("clip-width") || 40, this[at] = t("height") || 40
			}
			build() {
				let a = this;
				...
				let o = a.option("parentEl"),
					...
					c = a.cn("track"),
					u = o ? .querySelector("." + l);
				u || (u = document.createElement("div"), v(u, l), o ? o.appendChild(u) : e.after(u)), v(u, `is-${n}`), v(e, a.cn("hasThumbs")), a.container = u, a.updateProps();
				let m = u.querySelector("." + c);
				m || (m = document.createElement("div"), v(m, a.cn("track")), u.appendChild(m)), a.track = m;
				let s = V({}, {
						track: m,
						infinite: !1,
						center: !0,
			...
			onClick(a) {
				...
				let t = this.instance,
					...
					n = b => {
						if (b) {
							...
							if (p) return [parseInt(p.dataset.carouselIndex || "", 10) || 0, p]
						}
						return [-1, void 0]
					},
					o = (b, p) => {
				...
				let u = this[A],
					...
					[r, d] = o(m - u, s),
					[h, f] = o(m + u, s);
				d && f ? (l = Math.abs(m - d.getBoundingClientRect().right) < Math.abs(m - f.getBoundingClientRect().left) ? r : h, l === i && (l = l === r ? h : r)) : d ? l = r : f && (l = h), l > -1 && e[l] && t.slideTo(l)
			}
			getShift(a) {
				var t;
				let e = this,
				...
				let m = .5 * (o - l),
					...
					p = r < 0 && r > -1,
					g = d > 0 && d < 1;
				return a === 0 ? (f = b * Math.abs(r), g && r === 1 && (f -= b * Math.abs(d))) : a === s ? (f = b * Math.abs(d) * -1, p && d === -1 && (f += b * Math.abs(r))) : p || g ? (f = -1 * b, f += b * Math.abs(r), f += b * (1 - Math.abs(d))) : f = b * h, f
			}
			setProps(a) {
				var t;
				let e = this;
				...
				if (i && n) {
					...
					if (o && o.childNodes.length) {
						let l = F(1 - Math.abs(i.getProgress(a))),
							c = F(e.getShift(a));
						o.style.setProperty("--progress", l ? l + "" : ""), o.style.setProperty("--shift", c + "")
					}
				}
			}
			shiftModern() {
				...
				let {
					instance: t,
					track: e
				} = a, i = t.panzoom, n = a.carousel;
				if (!(t && e && i && n) || i.state === w.Init || i.state === w.Destroy) return;
			...
			cleanup() {
				let a = this;
				a.carousel && a.carousel.destroy(), a.carousel = null, a.container && a.container.remove(), a.container = null, a.track && a.track.remove(), a.track = null, a.state = P.Init, U(a.instance.container, a.cn("hasThumbs"))
			}
			attach() {
				let a = this,
					t = a.instance;
				t.on("initSlide", a.onInitSlide), t.state === Z.Init ? t.on("initSlides", a.onInitSlides) : a.onInitSlides(), t.on(["change", "Panzoom.afterTransform"], a.onChange), t.on("Panzoom.refresh", a.onRefresh)
			}
			detach() {
				let a = this,
					t = a.instance;
				t.off("initSlide", a.onInitSlide), t.off("initSlides", a.onInitSlides), t.off(["change", "Panzoom.afterTransform"], a.onChange), t.off("Panzoom.refresh", a.onRefresh), a.cleanup()
			}
		};
	...
	var ms = Object.assign(Object.assign({}, $i), {
		...
		te = class extends Y {
			...
			onInit() {
				...
				l.Carousel = l.Carousel || {}, l.Carousel.on = V(((t = e.options.Carousel) === null || t === void 0 ? void 0 : t.on) || {}, {
					click: this.onClick,
					createSlide: this.onCreateSlide
				}), n.options.Thumbs = l, n.attachPlugins({
					Thumbs: qi
				}), e.ref = n.plugins.Thumbs, e.option("showOnStart") || (e.ref.state = P.Hidden, e.hidden = !0)
			}
			onResize() {
				var t;
			...
			toggle() {
				let t = this.ref;
				if (t && !t.isDisabled()) return t.state === P.Hidden ? (t.state = P.Init, void t.build()) : void(this.hidden ? this.show() : this.hide())
			}
			show() {
				let t = this.ref;
				if (!t || t.isDisabled()) return;
				let e = t.container;
				e && (this.refresh(), e.offsetHeight, e.removeAttribute(Oi), e.classList.remove(ki), this.hidden = !1)
			}
			hide() {
				let t = this.ref,
					e = t && t.container;
				e && (this.refresh(), e.offsetHeight, e.classList.add(ki), e.setAttribute(Oi, "true")), this.hidden = !0
			}
			refresh() {
				let t = this.ref;
				if (!t || !t.state) return;
			...
			attach() {
				let t = this,
					e = t.instance;
				e.state === O.Init ? e.on("Carousel.init", t.onInit) : t.onInit(), e.on("resize", t.onResize), e.on("keydown", t.onKeydown)
			}
			detach() {
				var t;
				let e = this,
					i = e.instance;
				i.off("Carousel.init", e.onInit), i.off("resize", e.onResize), i.off("keydown", e.onKeydown), (t = i.carousel) === null || t === void 0 || t.detachPlugins(["Thumbs"]), e.ref = null
			}
		};
	...
	var Ye = {
		...
		nt;
	(function(a) {
		a[a.Init = 0] = "Init", a[a.Ready = 1] = "Ready", a[a.Disabled = 2] = "Disabled"
	})(nt || (nt = {}));
	var fs = {
			absolute: "auto",
			display: {
		...
		ee = class extends Y {
			...
			onReady(t) {
				...
				if (l && (u = this.createContainer()), u) {
					for (let [m, s] of Object.entries(c)) {
						...
						n !== "auto" || m !== "middle" || s.length || (n = !0), u.appendChild(r)
					}
					n === !0 && v(u, "is-absolute"), this.state = nt.Ready, this.onRefresh()
			...
			onClick(t) {
				...
				if (!u) return;
				if (u.fancyboxToggleThumbs !== void 0) return t.preventDefault(), t.stopPropagation(), void((e = n.plugins.Thumbs) === null || e === void 0 || e.toggle());
			...
			onRefresh() {
				...
				for (let l of t.querySelectorAll("[data-panzoom-action]")) i ? (l.removeAttribute("disabled"), l.removeAttribute("tabindex")) : (l.setAttribute("disabled", ""), l.setAttribute("tabindex", "-1"));
				let n = i && i.canZoomIn(),
					o = i && i.canZoomOut();
				for (let l of t.querySelectorAll('[data-panzoom-action="zoomIn"]')) n ? (l.removeAttribute("disabled"), l.removeAttribute("tabindex")) : (l.setAttribute("disabled", ""), l.setAttribute("tabindex", "-1"));
				for (let l of t.querySelectorAll('[data-panzoom-action="zoomOut"]')) o ? (l.removeAttribute("disabled"), l.removeAttribute("tabindex")) : (l.setAttribute("disabled", ""), l.setAttribute("tabindex", "-1"));
				for (let l of t.querySelectorAll('[data-panzoom-action="toggleZoom"],[data-panzoom-action="iterateZoom"]')) {
					o || n ? (l.removeAttribute("disabled"), l.removeAttribute("tabindex")) : (l.setAttribute("disabled", ""), l.setAttribute("tabindex", "-1"));
			...
			createContainer() {
				...
				return i || (i = document.createElement("div"), v(i, _e), e.prepend(i)), i.addEventListener("click", this.onClick, {
					passive: !1,
					capture: !0
				}), t && v(t, Mi), this.container = i, i
			}
			createEl(t) {
				let e = this.instance,
					i = e.carousel;
				if (!i || t === "toggleFS" || t === "fullscreen" && !ji()) return null;
				let n = null,
					o = i.slides.length || 0,
					l = 0,
					c = 0;
				for (let m of i.slides)(m.panzoom || m.type === "image") && l++, (m.type === "image" || m.downloadSrc) && c++;
				...
				if (Ye[t] !== void 0) {
					let m = Ye[t];
					n = document.createElement("button"), n.setAttribute("title", this.instance.localize(`{{${t.toUpperCase()}}}`)), v(n, "f-button"), m.action && (n.dataset.panzoomAction = m.action), m.change && (n.dataset.panzoomChange = JSON.stringify(m.change)), n.appendChild(S(this.instance.localize(m.icon)))
				} else {
					let m = (this.option("items") || [])[t];
					m && (n = S(this.instance.localize(m.tpl)), typeof m.click == "function" && n.addEventListener("click", s => {
						s.preventDefault(), s.stopPropagation(), typeof m.click == "function" && m.click.call(this, this, s)
					}))
				}
				let u = n ? .querySelector("svg");
				if (u)
					for (let [m, s] of Object.entries(ps)) u.getAttribute(m) || u.setAttribute(m, String(s));
				return n
			}
			removeContainer() {
				let t = this.container;
	...
	var bs = {
			Hash: class extends Y {
				...
				onChange(a) {
					...
					let {
						...
						hash: e
					} = Ht(), i = a.isOpeningSlide(a.getSlide());
					i && (Li = e === t ? "" : e), t && t !== e && (it = setTimeout(() => {
						try {
							if (a.state === O.Ready) {
								let n = "replaceState";
								i && !Dt && (n = "pushState", Dt = !0), window.history[n]({}, document.title, window.location.pathname + window.location.search + t)
							}
						} catch {}
					}, 300))
				}
				onClose(a) {
					if (it && clearTimeout(it), !Qt && Dt) return Dt = !1, Qt = !1, void window.history.back();
					if (!Qt) try {
				...
				attach() {
					let a = this.instance;
					a.on("ready", this.onReady), a.on(["Carousel.ready", "Carousel.change"], this.onChange), a.on("close", this.onClose)
				}
				detach() {
					let a = this.instance;
					a.off("ready", this.onReady), a.off(["Carousel.ready", "Carousel.change"], this.onChange), a.off("close", this.onClose)
				}
				static parseURL() {
					return Ht()
				}
		...
		ct = new Map,
		gs = 0,
		E = class a extends yt {get isIdle() {
				return this.idle
			}
			get isCompact() {
			...
			constructor(t = [], e = {}, i = {}) {
				super(e), Object.defineProperty(this, "userSlides", {
					...
					writable: !0,
					value: void 0
				}), G || (G = ji()), this.id = e.id || ++gs, ct.set(this.id, this), this.userSlides = t, this.userPlugins = i, queueMicrotask(() => {
					this.init()
				})
			}
			init() {
				if (this.state === O.Destroy) return;
				this.state = O.Init, this.attachPlugins(Object.assign(Object.assign({}, a.Plugins), this.userPlugins)), this.emit("init"), this.emit("attachPlugins"), this.option("hideScrollbar") === !0 && (() => {
					if (!Ft) return;
					let e = document,
						i = e.body,
						n = e.documentElement;
					...
					o < 0 && (o = 0), n.style.setProperty(Ri, `${o}px`), l && i.style.setProperty(Vi, `${l}px`), i.classList.add(De)
			...
			initLayout() {
				...
				if (n) {
					if (n.setAttribute("id", `fancybox-${this.id}`), n.setAttribute("aria-label", this.localize("{{MODAL}}")), n.classList.toggle(Yi, this.isCompact), v(n, this.option("mainClass") || ""), v(n, Te), this.container = n, this.footer = n.querySelector(".fancybox__footer"), i.appendChild(n), v(document.documentElement, Ii), N && et || (N = document.createElement("span"), v(N, "fancybox-focus-guard"), N.setAttribute(tt, "0"), N.setAttribute(Xe, "true"), N.setAttribute("aria-label", "Focus guard"), et = N.cloneNode(), (t = n.parentElement) === null || t === void 0 || t.insertBefore(N, n), (e = n.parentElement) === null || e === void 0 || e.append(et)), n.addEventListener("mousedown", o => {
							Gi = o.pageX, Ni = o.pageY, U(n, Ge)
						}), this.option("closeExisting"))
						for (let o of ct.values()) o.id !== this.id && o.close();
					else this.option("animated") && (v(n, Ne), setTimeout(() => {
			...
			initCarousel(t) {
				...
				n.on("*", (o, l, ...c) => {
					...
					var o, l;
					this.isCompact || this.endIdle(), !((o = document.activeElement) === null || o === void 0) && o.closest(".f-thumbs") && ((l = this.container) === null || l === void 0 || l.focus())
				}), n.on("settle", () => {
					...
					var u;
					let m = this.getSlide();
					if (m && Se(m.el) || l.isMobile && document.activeElement && ["TEXTAREA", "INPUT"].indexOf((u = document.activeElement) === null || u === void 0 ? void 0 : u.nodeName) !== -1) return;
					...
					if (!l) return;
					for (let m of l.querySelectorAll("[data-fancybox-current-index]")) m.innerHTML = o.page + 1;
					for (let m of l.querySelectorAll("[data-fancybox-count]")) m.innerHTML = o.pages.length;
					if (!o.isInfinite) {
						for (let m of l.querySelectorAll("[data-fancybox-next]")) o.page < o.pages.length - 1 ? (m.removeAttribute(rt), m.removeAttribute(tt)) : (m.setAttribute(rt, ""), m.setAttribute(tt, "-1"));
						for (let m of l.querySelectorAll("[data-fancybox-prev]")) o.page > 0 ? (m.removeAttribute(rt), m.removeAttribute(tt)) : (m.setAttribute(rt, ""), m.setAttribute(tt, "-1"))
					}
					let c = this.getSlide();
					if (!c) return;
					let u = c.downloadSrc || "";
					...
					for (let m of l.querySelectorAll("[data-fancybox-download]")) {
						...
						u ? (m.removeAttribute(rt), m.removeAttribute(tt), m.setAttribute(Ae, u), m.setAttribute(Di, s || u), m.setAttribute("target", "_blank")) : (m.setAttribute(rt, ""), m.setAttribute(tt, "-1"), m.removeAttribute(Ae), m.removeAttribute(Di))
					}
			...
			scale() {
				...
				if (e && i > 1) {
					let c = `${e.offsetLeft}px`,
						u = `${e.offsetTop}px`;
					n = e.width * i + "px", o = e.height * i + "px", l = `translate3d(${c}, ${u}, 0) scale(${1/i})`
				}
			...
			onClick(t) {
				...
				if (o.closest(".fancybox-spinner") || o.closest("[data-fancybox-close]")) return t.preventDefault(), void this.close(t);
				...
				if (t.type === "click" && t.detail === 0 || Math.abs(t.pageX - Gi) > 30 || Math.abs(t.pageY - Ni) > 30) return;
				...
				} else o.closest(".fancybox__carousel") && !o.matches(Ie) && (c = this.option("backdropClick"));
			...
			onWheel(t) {
				...
				let n = i === "slide",
					...
					c = Date.now();
				this.pwt && c - this.pwt < 300 ? n && t.preventDefault() : (this.pwt = c, this.emit("wheel", t, l), t.defaultPrevented || (i === "close" ? (t.preventDefault(), this.close(t)) : i === "slide" && (St(e) || (t.preventDefault(), this[l > 0 ? "prev" : "next"]()))))
			}
			onScroll() {
			...
			onKeydown(t) {
				...
				if (e !== "Escape" && !l && R(n) && (n.isContentEditable || ["TEXTAREA", "OPTION", "INPUT", "SELECT", "VIDEO"].indexOf(n.nodeName) !== -1) || (t.key === "Tab" ? v(this.container, Ge) : U(this.container, Ge), t.ctrlKey || t.altKey || t.shiftKey)) return;
			...
			onResize() {
				...
				t.classList.toggle(Yi, e), this.manageCaption(this.getSlide()), this.isCompact ? this.clearIdle() : this.endIdle(), this.scale(), this.emit("resize")
			}
			onFocus(t) {
			...
			manageCloseBtn(t) {
				...
				if (i) {
					...
					t.closeBtnEl = t.contentEl.appendChild(n), t.el && v(t.el, "has-close-btn")
				}
			}
			manageCaption(t = void 0) {
				...
				if (this.caption && this.stop(this.caption), c && this.caption && (this.caption.remove(), this.caption = null), l && !this.caption)
					for (let r of((e = this.carousel) === null || e === void 0 ? void 0 : e.slides) || []) r.captionEl && (r.captionEl.remove(), r.captionEl = void 0, U(r.el, At), (i = r.el) === null || i === void 0 || i.removeAttribute("aria-labelledby"));
				...
				if (c) {
					if (s = t.captionEl || null, u && !s) {
						...
						s = document.createElement("div"), v(s, n), s.setAttribute("id", r), t.captionEl = u.appendChild(s), v(u, At), u.setAttribute("aria-labelledby", r)
					}
				} else s = this.caption, s || (s = o.querySelector("." + n)), !s && (s = document.createElement("div"), s.dataset.fancyboxCaption = "", v(s, n), (this.footer || o).prepend(s)), v(o, At), this.caption = s;
				s && (s.innerHTML = "", K(m) || typeof m == "number" ? s.innerHTML = m + "" : m instanceof HTMLElement && s.appendChild(m))
			}
			checkFocus(t) {
				this.focus(t)
			}
			focus(t) {
				...
				for (let h of m) {
					...
					if (h === o || (b || p) && !f) {
						...
						g !== void 0 && g && (h.tabIndex = parseFloat(g)), h.removeAttribute("data-orig-tabindex"), !h.hasAttribute("autoFocus") && r || (r = h)
					} else {
				...
				let d = null;
				t ? (!n || s.indexOf(n) < 0) && (d = r || o, s.length && (i === et ? d = s[0] : this.lastFocus !== o && i !== N || (d = s[s.length - 1]))) : d = c && c.type === "image" ? o : r || o, d && wi(d), this.lastFocus = document.activeElement, this.ignoreFocusChange = !1
			}
			next() {
				let t = this.carousel;
			...
			animate(t = null, e = "", i) {
				...
				this.stop(t);
				let n = o => {
					o.target === t && t.dataset.animationName && (t.removeEventListener("animationend", n), delete t.dataset.animationName, i && i(), U(t, e))
				};
				t.dataset.animationName = e, t.addEventListener("animationend", n), v(t, e)
			}
			stop(t) {
			...
			setContent(t, e = "", i = !0) {
				...
				if (!n) return;
				let o = null;
				if (R(e) ? o = e : (o = S(e + ""), R(o) || (o = document.createElement("div"), o.innerHTML = e + "")), ["img", "picture", "iframe", "video", "audio"].includes(o.nodeName.toLowerCase())) {
					let l = document.createElement("div");
					l.appendChild(o), o = l
				}
				R(o) && t.filter && !t.error && (o = o.querySelector(t.filter)), o && R(o) ? (v(o, "fancybox__content"), t.id && o.setAttribute("id", t.id), n.classList.add(`has-${t.error?"error":t.type||"unknown"}`), n.prepend(o), o.style.display === "none" && (o.style.display = ""), getComputedStyle(o).getPropertyValue("display") === "none" && (o.style.display = t.display || this.option("defaultDisplay") || "flex"), t.contentEl = o, i && this.revealContent(t), this.manageCloseBtn(t), this.manageCaption(t)) : this.setError(t, "{{ELEMENT_NOT_FOUND}}")
			}
			revealContent(t, e) {
				let i = t.el,
					n = t.contentEl;
				i && n && (this.emit("reveal", t), this.hideLoading(t), t.state = I.Opening, (e = this.isOpeningSlide(t) ? e === void 0 ? this.optionFor(t, "showClass") : e : "f-fadeIn") ? this.animate(n, e, () => {
					this.done(t)
				}) : this.done(t))
			}
			done(t) {
				this.isClosing() || (t.state = I.Ready, this.emit("done", t), v(t.el, "is-done"), this.isCurrentSlide(t) && this.option("autoFocus") && queueMicrotask(() => {
					var e;
					(e = t.panzoom) === null || e === void 0 || e.updateControls(), this.option("autoFocus") && this.focus()
				}), this.isOpeningSlide(t) && (U(this.container, Te), !this.isCompact && this.option("idle") && this.setIdle()))
			}
			isCurrentSlide(t) {
				let e = this.getSlide();
			...
			showLoading(t) {
				t.state = I.Loading;
				let e = t.el;
				e && (v(e, _i), this.emit("loading", t), t.spinnerEl || setTimeout(() => {
					if (!this.isClosing() && !t.spinnerEl && t.state === I.Loading) {
						let i = S(Pe);
						v(i, "fancybox-spinner"), t.spinnerEl = i, e.prepend(i), this.animate(i, "f-fadeIn")
					}
				}, 250))
			}
			hideLoading(t) {
				...
				if (!e) return;
				let i = t.spinnerEl;
				this.isClosing() ? i ? .remove() : (U(e, _i), i && this.animate(i, "f-fadeOut", () => {
					i.remove()
				}), t.state === I.Loading && (this.emit("loaded", t), t.state = I.Ready))
			}
			setError(t, e) {
				if (this.isClosing()) return;
			...
			clearContent(t) {
				...
				let e = t.el;
				e && (U(e, "has-error"), U(e, "has-unknown"), U(e, `has-${t.type||"unknown"}`)), t.closeBtnEl && t.closeBtnEl.remove(), t.closeBtnEl = void 0, t.captionEl && t.captionEl.remove(), t.captionEl = void 0, t.spinnerEl && t.spinnerEl.remove(), t.spinnerEl = void 0
			}
			getSlide() {
				var t;
				let e = this.carousel;
			...
			endIdle() {
				this.clearIdle(), this.idle && !this.isClosing() && (this.idle = !1, U(this.container, "is-idle"), this.emit("endIdle"))
			}
			resetIdle() {
			...
			proceedClose(t, e) {
				...
				if (u && (zi(u) ? wi(u) : u.focus()), o && (U(o, Te), v(o, "is-closing"), o.setAttribute(Xe, "true"), this.option("animated") && v(o, Ne), o.style.pointerEvents = "none"), l) {
					l.clearTransitions(), (i = l.panzoom) === null || i === void 0 || i.destroy(), (n = l.plugins.Navigation) === null || n === void 0 || n.detach();
				...
				Ti = window.scrollX, Ai = window.scrollY, window.addEventListener("scroll", this.onScroll), this.emit("close", t), this.state !== O.CustomClosing ? (e === void 0 && c && (e = this.optionFor(c, "hideClass")), e && c ? (this.animate(c.contentEl, e, () => {
			...
			destroy() {
				var t;
				if (this.state === O.Destroy) return;
				window.removeEventListener("scroll", this.onScroll), this.state = O.Destroy, (t = this.carousel) === null || t === void 0 || t.destroy();
				let e = this.container;
				e && e.remove(), ct.delete(this.id);
				let i = a.getInstance();
				i ? i.focus() : (N && (N.remove(), N = null), et && (et.remove(), et = null), U(document.documentElement, Ii), (() => {
					if (!Ft) return;
					let n = document,
						o = n.body;
					o.classList.remove(De), o.style.setProperty(Vi, ""), n.documentElement.style.setProperty(Ri, "")
				})(), this.emit("destroy"))
			}
			static bind(t, e, i) {
				if (!Ft) return;
				let n, o = "",
					l = {};
				if (t === void 0 ? n = document.body : K(t) ? (n = document.body, o = t, typeof e == "object" && (l = e || {})) : (n = t, K(e) && (o = e), typeof i == "object" && (l = i || {})), !n || !R(n)) return;
				o = o || "[data-fancybox]";
				let c = a.openers.get(n) || new Map;
				c.set(o, l), a.openers.set(n, c), c.size === 1 && n.addEventListener("click", a.fromEvent)
			}
			static unbind(t, e) {
				let i, n = "";
				if (K(t) ? (i = document.body, n = t) : (i = t, K(e) && (n = e)), !i) return;
				let o = a.openers.get(i);
				o && n && o.delete(n), n && o || (a.openers.delete(i), i.removeEventListener("click", a.fromEvent))
			}
			static destroy() {
				let t;
				for (; t = a.getInstance();) t.destroy();
				for (let e of a.openers.keys()) e.removeEventListener("click", a.fromEvent);
				a.openers = new Map
			}
			static fromEvent(t) {
				...
				if ((!e || d || s) && (u = [].slice.call(n.querySelectorAll(o))), e && !s && (u = d ? u.filter(f => f.getAttribute(`${r}`) === d) : [e]), !u.length) return;
				let h = a.getInstance();
				return h && h.options.triggerEl && u.indexOf(h.options.triggerEl) > -1 ? void 0 : (e && (m.startIndex = u.indexOf(e)), a.fromNodes(u, m))
			}
			static fromSelector(t, e, i) {
				let n = null,
					o = "",
					l = {};
				if (K(t) ? (n = document.body, o = t, typeof e == "object" && (l = e || {})) : t instanceof HTMLElement && K(e) && (n = t, o = e, typeof i == "object" && (l = i || {})), !n || !o) return !1;
				let c = a.openers.get(n);
				return !!c && (l = V({}, c.get(o) || {}, l), !!l && a.fromNodes(Array.from(n.querySelectorAll(o)), l))
			}
			static fromNodes(t, e) {
				...
				for (let n of t) {
					let o = n.dataset || {},
						l = o[lt] || n.getAttribute(Ae) || n.getAttribute("currentSrc") || n.getAttribute(lt) || void 0,
						c, u = e.delegate,
						m;
					u && i.length === e.startIndex && (c = u instanceof HTMLImageElement ? u : u.querySelector("img:not([aria-hidden])")), c || (c = n instanceof HTMLImageElement ? n : n.querySelector("img:not([aria-hidden])")), c && (m = c.currentSrc || c[lt] || void 0, !m && c.dataset && (m = c.dataset.lazySrc || c.dataset[lt] || void 0));
					let s = {
						src: l,
						triggerEl: n,
						thumbEl: c,
			...
			static close(t = !0, ...e) {
				if (t)
					for (let i of ct.values()) i.close(...e);
				else {
					let i = a.getInstance();
					i && i.close(...e)
				}
	...
	var Ke = class extends _ {
		...
		showImage(a) {
			...
			let e = parseInt(t.dataset.clicks),
				i = t.dataset.image,
				n = "image";
			i.includes("https://") || (n = "inline"), `image${e}` in t.dataset && (i = t.dataset[`image${e}`], i.includes("https://") || (n = "inline")), "imagemax" in t.dataset && "imageoverflow" in t.dataset && e > parseInt(t.dataset.imagemax) && (i = t.dataset.imageoverflow, n = "inline", this.audioEnded()), n == "inline" ? new E([{
				src: `#${i}`,
				type: "inline"
			}], {
				backdropClick: !1,
				...
				on: {
					reveal: o => {
						for (let c of o.getSlide().contentEl.querySelectorAll("video")) c.play();
					...
					close: o => {
						for (let u of o.getSlide().contentEl.querySelectorAll("video")) u.pause();
						let l = this.application.getControllerForElementAndIdentifier(document.getElementById("desk_frame"), "secrets"),
		...
		showContent(a) {
			...
			document.getElementById(t) ? this.fancyContent(t) : fetch(t).then(async i => {
				let n = document.createElement("div");
				n.setAttribute("id", t), n.classList.add("hidden", "html"), n.innerHTML = await i.text(), document.body.appendChild(n), this.fancyContent(t)
			})
		}
		fancyContent(a) {
			new E([{
		...
		printImage(a) {
			...
			if (t) {
				...
				e.document.open(), e.document.write(`<html><head><meta name="viewport" content="width=device-width, initial-scale=1.0" /></head><body onload="window.print(); window.close()" onafterprint="window.close()"><img src="${t.src}" style="width: 100%; height: auto" /></body></html>`), e.document.close()
			}
		}
		nextImage(a) {
	...
	var qe = class extends _ {
		flipImage(a) {
			for (let t of document.querySelectorAll(`#${a.params.image}`)) {
				...
				t.classList.remove("animate-flip-out"), t.classList.add("animate-flip-in"), setTimeout(function() {
					let e = t.src,
						i = t.dataset.back;
					t.src = i, t.setAttribute("data-back", e), t.classList.remove("animate-flip-in"), t.classList.add("animate-flip-out")
				}, 150)
			}
		}
	};
	...
	var vt = class extends _ {
		connect() {
			this.hasVideo1Target && this.loaded1Value == !1 && (this.badCodes = [], this.video1Target.load(), this.video2Target.load(), this.initiateSFX(), this.initiateBGM())
		}
		initiateSFX() {
			this.sfx = {}, this.sfx.begin = new L.Howl({
		...
		initiateBGM() {
			this.bgm = {}, this.bgm.info = new L.Howl({
				src: ["/assets/info.mp3"],
				loop: !0,
		...
		showImage(a) {
			...
			let e = parseInt(t.dataset.clicks),
				i = t.dataset.image;
			`image${e}` in t.dataset && (i = t.dataset[`image${e}`]), new E([{
				src: i
			}], {
				backdropClick: !1,
				contentClick: !1,
		...
		fancyContent(a) {
			...
			if (e) {
				...
				u[c].classList.remove("hidden"), "text" in u[c].dataset && (n = u[c].dataset.text), "audio" in u[c].dataset && (i = u[c].dataset.audio), "video" in u[c].dataset && (o = u[c].dataset.video);
				let m = c + 1;
			...
			if (n) this.showText(n);
				...
				for (let m of document.querySelectorAll(`[data-fancybox='${u}']`)) c.push({
					src: m.src,
					type: "image"
				});
				new E(c, {
			...
			} else(t.classList.contains("html") || t.classList.contains("text") || t.classList.contains("link") || t.classList.contains("image") || t.classList.contains("video") || t.classList.contains("audio")) && new E([{
				src: `#${a}`,
				type: "inline"
			}], {
				backdropClick: !1,
				...
				on: {
					reveal: c => {
						this.sfx !== void 0 && (i ? this.sfx[i].play() : this.sfx.reveal.play()), this.bgm !== void 0 && c.getSlide().contentEl.children.length > 0 && "bgm" in c.getSlide().contentEl.children[0].dataset && this.playBGM(c.getSlide().contentEl.children[0].dataset.bgm);
						for (let u of c.getSlide().contentEl.querySelectorAll("video")) u.play()
					},
					close: c => {
						this.sfx !== void 0 && this.sfx.unreveal.play(), this.bgm !== void 0 && this.bgmPlayingValue != "rain" && this.playBGM("rain");
						for (let m of c.getSlide().contentEl.querySelectorAll("video")) m.pause();
						let u = document.querySelector("audio.playing");
		...
		waiting() {
			this.waitingValue = !0, this.loaderTarget.classList.add("!opacity-100"), this.checkLoaded()
		}
		loaded1() {
		...
		checkLoaded() {
			this.loaded1Value && this.loaded2Value && (this.readyValue = !0), this.readyValue && this.waitingValue && this.begin()
		}
		begin() {
			this.loaderTarget.classList.add("!duration-100"), this.loaderTarget.classList.remove("!opacity-100"), this.startScreenTarget.classList.add("pointer-events-none", "opacity-0"), this.startScreenTarget.pause(), this.shadowTarget.classList.add("!shadow-darken"), this.video1Target.play(), this.video2Target.play(), this.volumeTarget.classList.remove("!opacity-0"), this.titleTarget.classList.remove("!opacity-0"), this.begunValue || (this.sfx.button.play(), this.sfx.begin.play(), this.playBGM("rain")), this.begunValue = !0
		}
		submit(a) {
			if (a.preventDefault(), this.buttonTarget.classList.contains("disabled")) return !1;
			if (this.fieldTarget.classList.remove("animate-error"), this.fieldTarget.classList.add("loading"), this.badOverlayTarget.classList.remove("animate-flash"), this.sfx.button.play(), this.screenOccupiedValue) return this.resetScreen(), !1;
			let t = a.target.code.value;
			t = t.toLowerCase(), t = t.replace(/[^a-z0-9?]/gi, "");
			let e = document.getElementById(t);
			if (e) e.classList.contains("part-of-ui") ? this.flashError() : e.classList.contains("text") ? this.randomText(t) : e.classList.contains("link") ? this.randomLink(t) : e.classList.contains("image") ? this.fancyImage(t) : e.classList.contains("video") ? this.playVideo(t) : e.classList.contains("audio") ? this.playAudio(t) : e.classList.contains("overlays") ? this.randomOverlay(t) : e.classList.contains("replacements") ? this.replaceSources(t) : this.fancyContent(t), this.fieldTarget.removeAttribute("readonly"), this.fieldTarget.classList.remove("loading"), this.buttonTarget.removeAttribute("disabled"), this.unpressButton();
			else if (this.badCodes.includes(t) || t.length < 2) this.flashError(), this.fieldTarget.removeAttribute("readonly"), this.fieldTarget.classList.remove("loading"), this.buttonTarget.removeAttribute("disabled"), this.unpressButton();
			else {
				this.buttonOverlayTarget.classList.add("pressed"), this.fieldTarget.setAttribute("readonly", !0), this.buttonTarget.setAttribute("disabled", !0);
				let i = new FormData;
				i.append("code", t), fetch("https://codes.thisisnotawebsitedotcom.com/", {
					method: "POST",
					body: i
				}).then(async n => {
					if (!n.ok) this.flashError(), n.status == "429" ? this.disableForm(3e4) : n.status == "404" ? this.badCodes.push(t) : this.disableForm(250);
					else {
						let o = n.headers.get("content-type");
						if (o == "text/html") {
							let l = document.createElement("div");
							l.setAttribute("id", t), l.innerHTML = await n.text(), l.children[0].classList.contains("has-text") ? (l.classList.add("hidden", "text"), document.body.appendChild(l), this.randomText(t)) : l.children[0].classList.contains("has-link") ? (l.classList.add("hidden", "link"), document.body.appendChild(l), this.randomLink(t)) : l.children[0].classList.contains("audio") ? (l.children[0].setAttribute("id", t), document.body.appendChild(l.children[0]), this.playAudio(t)) : l.children[0].classList.contains("has-overlays") ? (l.children[0].setAttribute("id", t), l.classList.add("hidden", "overlays"), document.body.appendChild(l), this.randomOverlay(t)) : l.children[0].classList.contains("has-replacements") ? (l.children[0].setAttribute("id", t), l.classList.add("hidden", "replacements"), document.body.appendChild(l), this.replaceSources(t)) : (l.classList.add("hidden", "html"), document.body.appendChild(l), this.fancyContent(t))
						} else if (o == "video/mp4") {
							let l = await n.blob(),
								c = URL.createObjectURL(l),
								u = document.createElement("video"),
								m = document.createElement("source");
							u.setAttribute("id", t), u.classList.add("hidden", "video"), m.src = c, m.setAttribute("type", "video/mp4"), document.getElementById("desk_frame").appendChild(u), u.appendChild(m), this.playVideo(t)
						} else if (o == "audio/mpeg") {
							let l = await n.blob(),
								c = URL.createObjectURL(l),
								u = document.createElement("audio"),
								m = document.createElement("source");
							u.setAttribute("id", t), u.classList.add("hidden", "audio"), u.setAttribute("data-action", "ended->secrets#audioEnded pause->secrets#audioEnded"), m.src = c, m.setAttribute("type", "audio/mpeg"), document.getElementById("desk_frame").appendChild(u), u.appendChild(m), this.playAudio(t)
						} else {
							let l = await n.blob(),
								c = URL.createObjectURL(l),
								u = document.createElement("img");
							u.setAttribute("id", t), u.src = c, u.classList.add("hidden", "image"), document.body.appendChild(u), this.fancyImage(t)
						}
					}
					this.fieldTarget.removeAttribute("readonly"), this.fieldTarget.classList.remove("loading"), this.buttonTarget.removeAttribute("disabled"), this.unpressButton()
				})
			}
		}
		resetScreen() {
			this.screenLoopsValue = 0, this.audioEnded(), this.screenTarget.pause(), this.videoEnded(), this.textVisibleForSeconds = 0, this.screenTextTarget.innerHTML = "", this.screenTextTarget.classList.remove("!opacity-100"), this.screenOverlayTarget.classList.remove("!opacity-100"), this.screenStaticTarget.classList.remove("!opacity-100"), this.fieldTarget.classList.remove("loading"), this.screenOccupiedValue = !1
		}
		flashError() {
			this.fieldTarget.offsetHeight, this.fieldTarget.classList.remove("loading"), this.fieldTarget.classList.add("animate-error"), this.badOverlayTarget.offsetHeight, this.badOverlayTarget.classList.add("animate-flash"), this.sfx.error.play()
		}
		disableForm(a = 1e3) {
			this.buttonTarget.classList.add("disabled"), a > 1e3 && (this.buttonOverlayTarget.classList.add("disabled"), this.fieldTarget.setAttribute("disabled", !0), this.buttonTarget.setAttribute("disabled", !0)), setTimeout(this.enableForm.bind(this), a)
		}
		enableForm() {
			this.buttonOverlayTarget.classList.remove("disabled"), this.fieldTarget.removeAttribute("disabled"), this.buttonTarget.removeAttribute("disabled"), this.buttonTarget.classList.remove("disabled")
		}
		adjustVolume() {
			if (this.volumeValue = this.volumeSliderTarget.value / 100, this.volumeValue > 0) {
				if (this.mutedValue = !1, this.screenTarget.volume = this.volumeValue, L.Howler.volume(this.volumeValue), this.audioPlayingValue) {
		...
		mutedValueChanged() {
			if (this.hasMuteButtonTarget && (this.mutedValue ? (this.muteButtonTarget.classList.add("muted"), this.muteButtonTarget.classList.remove("unmuted")) : (this.muteButtonTarget.classList.remove("muted"), this.muteButtonTarget.classList.add("unmuted"))), this.hasScreenTarget && (this.mutedValue ? (this.screenTarget.volume = 0, this.screenTarget.muted = !0) : (this.screenTarget.volume = this.volumeValue, this.screenTarget.muted = !1)), this.mutedValue) {
				if (L.Howler.mute(!0), L.Howler.volume(0), this.audioPlayingValue) {
					let a = document.querySelector("audio.playing");
					a.volume = 0
				}
			} else if (L.Howler.mute(!1), L.Howler.volume(this.volumeValue), this.audioPlayingValue) {
				let a = document.querySelector("audio.playing");
				a.volume = this.volumeValue
			}
		}
		playVideo(a = "") {
			if (this.screenOccupiedValue) this.videoPlayingValue.includes("static") && (this.screenTarget.pause(), this.videoEnded());
			else {
				if (typeof a == "string") {
					let t = document.getElementById(a),
						e = t.querySelector("source").src;
					this.videoPlayingValue = e, "linkatend" in t.dataset && "endsat" in t.dataset && setTimeout(function() {
				...
				this.screenOverlayTarget.classList.add("!opacity-100"), this.screenStaticTarget.classList.add("!opacity-100"), this.screenTarget.classList.add("!opacity-100"), this.screenSourceTarget.setAttribute("src", this.videoPlayingValue), this.screenTarget.load(), this.screenTarget.currentTime = 0, this.screenTarget.play(), this.videoPlayingValue.includes("static") && this.staticSFX(), this.pauseBGM(), this.screenOccupiedValue = !0
			}
		}
		videoEnded() {
			this.videoPlayingValue && (this.screenLoopsValue > 0 ? (this.screenLoopsValue -= 1, this.screenTarget.currentTime = 0, this.screenTarget.play()) : (this.videoPlayingValue = "", this.screenOverlayTarget.classList.remove("!opacity-100"), this.screenStaticTarget.classList.remove("!opacity-100"), this.screenTarget.classList.remove("!opacity-100"), this.staticPlayingValue && this.sfx[this.staticPlayingValue].stop(), this.resumeBGM(), this.screenOccupiedValue = !1))
		}
		videoLoop() {
			this.video1Target.currentTime = 0, this.video2Target.currentTime = 0, this.video1Target.play(), this.video2Target.play(), Math.floor(Math.random() * 6) + 1 > 4 ? (this.video2Target.classList.remove("hidden"), setTimeout(this.lightningSFX.bind(this), 2500)) : this.video2Target.classList.add("hidden")
		}
		staticSFX() {
			this.staticPlayingValue && this.sfx[this.staticPlayingValue].stop();
			let a = Math.floor(Math.random() * 3) + 1;
			this.staticPlayingValue = `static${a}`, this.sfx[this.staticPlayingValue].play()
		}
		lightningSFX() {
		...
		playBGM(a) {
			this.bgmPlayingValue && this.bgmPlayingValue != a && this.bgm[this.bgmPlayingValue].stop(), this.bgmPlayingValue = a, this.resumeBGM()
		}
		pauseBGM() {
		...
		playAudio(a) {
			if (!this.screenOccupiedValue) {
				...
				let t = document.getElementById(a);
				t.volume = this.volumeValue, t.classList.add("playing"), "audiolog" in t.dataset ? this.playVideo("audiolog") : "music" in t.dataset ? this.playVideo("music") : this.playVideo("small"), this.screenLoopsValue = 99, t.play(), this.pauseBGM(), this.screenOccupiedValue = !0
			}
		}
		playSound(a) {
		...
		audioEnded() {
			...
			if (a) {
				a.currentTime = 0, a.pause(), a.classList.remove("playing"), this.audioPlayingValue = "";
				let t = document.querySelector(".speaker-visible");
				t && t.classList.remove("speaker-visible"), this.videoPlayingValue && (this.screenLoopsValue = 0, this.videoEnded()), this.resumeBGM(), this.screenOccupiedValue = !1
			}
		}
		audioPaused() {
			let a = document.getElementById(this.audioPlayingValue);
		...
		randomLink(a) {
			...
			if ("inorder" in t.dataset) {
				let o = 0;
				"next" in t.dataset && (o = parseInt(t.dataset.next)), n = e[o], o += 1, o > e.length - 1 && (o -= 1), t.setAttribute("data-next", o)
			}
			if (n.includes("https")) {
				let o = document.createElement("a");
				o.classList.add("hidden"), o.setAttribute("href", n), o.setAttribute("target", "_blank"), o.setAttribute("rel", "noopener"), document.body.appendChild(o), setTimeout(function() {
					o.click(), document.body.removeChild(o)
				}, 100)
			} else {
				let o = document.getElementById(n);
				if (document.getElementById(`${n}_wrapper`)) this.fancyContent(`${n}_wrapper`);
				else {
					let c = document.createElement("div");
					c.setAttribute("id", `${n}_wrapper`), c.appendChild(o), c.classList.add("hidden", "html"), document.body.appendChild(c), o.classList.remove("hidden"), this.fancyContent(`${n}_wrapper`)
				}
			}
		}
		randomText(a) {
			...
			if ("inorder" in t.dataset) {
				let o = 0;
				"next" in t.dataset && (o = parseInt(t.dataset.next)), n = e[o], o += 1, o > e.length - 1 && (o = 0), t.setAttribute("data-next", o)
			}
			this.screenTextTarget.innerHTML = n, this.screenTextTarget.classList.add("!opacity-100"), this.screenOverlayTarget.classList.add("!opacity-100"), this.screenStaticTarget.classList.add("!opacity-100"), this.textVisibleForSeconds = Math.ceil(n.length / 5), this.screenTextTarget.classList.remove("lotsa-text"), n.length > 30 && this.screenTextTarget.classList.add("lotsa-text"), this.screenOccupiedValue = !0, setTimeout(this.textCountdown.bind(this), 1e3)
		}
		randomOverlay(a) {
			let t = document.getElementById(a).children[0],
			...
			if (e.length > 0) {
				...
				let o = document.createElement("div");
				o.classList.add("absolute", "top-0", "right-0", "left-0", "bottom-0", "opacity-0", "pointer-events-none", "z-30", "animate-overlay", "origin-center"), o.appendChild(n), document.getElementById("desk_form").appendChild(o), this.sfx.pop.play()
			} else "alloverlays" in t.dataset && this.showText(t.dataset.alloverlays)
		}
		showText(a) {
			this.screenTextTarget.innerHTML = a, this.screenTextTarget.classList.add("!opacity-100"), this.screenOverlayTarget.classList.add("!opacity-100"), this.screenStaticTarget.classList.add("!opacity-100"), this.textVisibleForSeconds = Math.ceil(a.length / 5), this.screenTextTarget.classList.remove("lotsa-text"), a.length > 35 && this.screenTextTarget.classList.add("lotsa-text"), this.screenOccupiedValue = !0, setTimeout(this.textCountdown.bind(this), 1e3)
		}
		textCountdown() {
			this.textVisibleForSeconds > 0 && (this.textVisibleForSeconds -= 1), this.textVisibleForSeconds > 0 ? setTimeout(this.textCountdown.bind(this), 1e3) : this.videoPlayingValue || this.resetScreen()
		}
		inputUpdate(a) {
			a.target.value.length > 0 ? this.clearButtonTarget.classList.add("active") : this.clearButtonTarget.classList.remove("active")
		}
		clearForm() {
			this.fieldTarget.value = "", this.fieldTarget.focus(), this.clearButtonTarget.classList.remove("active")
		}
		replaceSources(a) {
			let t = [];
			...
			for (let e of t) {
				let i = e.split(","),
					n = i[0],
					o = i[1];
				if (n.includes("sfx_")) this.sfx[n.replace("sfx_", "")].unload(), this.sfx[n.replace("sfx_", "")] = new L.Howl({
					src: [o],
					loop: !0
				});
				else {
					let l = document.getElementById(n),
						c = l.children[0];
					c.src != o && (n.includes("desk") && (this.startScreenTarget.classList.remove("opacity-0"), this.startScreenTarget.play(), this.shadowTarget.classList.remove("!shadow-darken")), n == "desk1" && (this.loaded1Value = !1), n == "desk2" && (this.loaded2Value = !1), c.src = o, l.load())
				}
			}
		}
	};
	se(vt, "targets", ["button", "field", "clearButton", "buttonOverlay", "badOverlay", "screenOverlay", "screenText", "screen", "screenStatic", "screenSource", "startScreen", "video1", "video2", "shadow", "volume", "volumeSlider", "muteButton", "loader", "title"]), se(vt, "values", {
		volume: {
			type: Number,
			default: .25
		},
